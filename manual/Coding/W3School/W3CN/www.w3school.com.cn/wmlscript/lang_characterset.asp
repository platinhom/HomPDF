...
<!-- Mirrored from www.w3school.com.cn/wmlscript/lang_characterset.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:52:35 GMT -->
<head>
...
<title>WMLScript characterSet() 函数</title>
</head>
...
<h1>WMLScript characterSet() 函数</h1>

<div class="backtoreference">
<p><a href="wmlscript_lib_lang.html" title="WMLScript Lang 库">返回 WMLScript Lang 库参考手册</a></p>
</div>

<div>
<p>characterSet() 函数返回 WMLScript 解释器所支持的字符集。</p>

<h3>语法</h3>
<pre>n = Lang.characterSet()</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>n</td>
    <td>从函数返回的定义字符集的整数。</td>
  </tr>
</table>

<h3>例子</h3>
<pre>var a = Lang.characterSet();</pre>
