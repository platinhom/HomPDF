...
<!-- Mirrored from www.w3school.com.cn/aspnet/control_label.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 07:05:31 GMT -->
<head>
...
<h1>ASP.NET Label 控件</h1>

<div class="backtoreference">
<p><a href="aspnet_refwebcontrols.asp" title="Web 服务器控件">Web 服务器控件参考手册</a></p>
</div>


<div>
<h2>定义和用法</h2>
<p>Label 控件用于在页面上显示文本。该文本是可编程的。</p>
<p class="note"><span>注释：</span>该控件允许您为内容应用样式！</p>
</div>
...
<tr>
<td>runat</td>
<td>规定该控件是一个服务器控件。必须设置为 &quot;server&quot;。</td>
</tr>

<tr>
<td>Text</td>
<td>在 label 中显示的文本。</td>
</tr>
</table>
</div>
...
<div>
<h2>Web 控件标准属性</h2>
<pre>AccessKey, Attributes, BackColor, BorderColor, BorderStyle, BorderWidth, 
CssClass, Enabled, Font, EnableTheming, ForeColor, Height, IsEnabled, 
SkinID, Style, TabIndex, ToolTip, Width</pre>
<p>如需完整描述，请访问 <a href="prop_webcontrol_standard.html" title="ASP.NET Web 控件标准属性">Web 控件标准属性</a>。</p>
</div>


<div>
<h2>控件标准属性</h2>
<pre>AppRelativeTemplateSourceDirectory, BindingContainer, ClientID, Controls, 
EnableTheming, EnableViewState, ID, NamingContainer, Page, Parent, Site, 
TemplateControl, TemplateSourceDirectory, UniqueID, Visible</pre>
<p>如需完整描述，请访问<a href="prop_control_standard.html" title="ASP.NET 控件标准属性">控件标准属性</a>。</p>
</div>
...
<h2>实例</h2>
<dl>
<dt><a target="_blank" href="../tiy/s27e5.html?f=demo_aspnet_label">Label</a></dt>
<dd>在本例中，我们在 .aspx 文件中声明了一个 Label 控件，一个 TextBox 控件，以及一个 Button 控件。当用户点击按钮时，会执行 submit 子例程。这个子例程会把 TextBox 控件的内容拷贝到 Label 控件。</dd>
</dl>
</div>
...
<!-- Mirrored from www.w3school.com.cn/aspnet/control_label.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 07:05:32 GMT -->
</html>