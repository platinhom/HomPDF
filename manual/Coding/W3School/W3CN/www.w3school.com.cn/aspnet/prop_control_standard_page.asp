...
<!-- Mirrored from www.w3school.com.cn/aspnet/prop_control_standard_page.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 07:33:33 GMT -->
<head>
...
<h1>ASP.NET Page 属性</h1>

<div class="backtoreference">
<p><a href="prop_control_standard.html" title="ASP.NET 控件标准属性">ASP.NET 控件标准属性</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>Page 属性获取对包含服务器控件的 Page 实例的引用。</p>

<p>该属性的值反映了包含服务器控件的 .aspx 文件的名称。</p>
</div>

<div>
<h2>实例</h2>

<p>本例显示包含 button 控件的 Page：</p>

<pre>&lt;script runat=&quot;server&quot;&gt;
Sub Button1_Click(sender As Object, e As EventArgs)
Response.Write(&quot;The Page containing the button is: &quot;)
Response.Write(<code>button1.Page</code>)
End Sub
&lt;/script&gt;
