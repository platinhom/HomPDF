...
<!-- Mirrored from www.w3school.com.cn/aspnet/prop_webcontrol_calendar_selecteddate.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 07:30:47 GMT -->
<head>
...
<title>ASP.NET SelectedDate 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>SelectedDate 属性用于设置或返回日历中被选的日期。</p>
</div>
...
<h3>例子 1</h3>
<p>下面的例子可在某日期被选择时输出这个被选的日期：</p>

<pre>&lt;script language=&quot;VB&quot; runat=&quot;server&quot;&gt;
Sub Change(obj As Object, e As EventArgs)
  Response.Write(&quot;Date: &quot;)
  Response.Write(<code>cal1.SelectedDate.ToShortDateString()</code>)
End Sub
&lt;/script&gt;
...
<h2>实例</h2>
<dl>
<dt>设置 Calendar 控件的 SelectedDate</dt>
</dl>
</div>
