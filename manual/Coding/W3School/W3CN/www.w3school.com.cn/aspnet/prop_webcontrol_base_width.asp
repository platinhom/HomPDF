...
<!-- Mirrored from www.w3school.com.cn/aspnet/prop_webcontrol_base_width.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 07:33:33 GMT -->
<head>
...
<p>Width 属性用于设置或返回控件的宽度。</p>

<h3>语法</h3>
<pre>&lt;asp:<i>webcontrol</i> id=&quot;<i>id</i>&quot; <code>Width=&quot;<i>value</i>&quot;</code> runat=&quot;server&quot;<i> /&gt;</i></pre>
...
<table class="dataintable">
	...
	<tr>
		<td>string</td>
		<td>控件的宽度。可以使像素值，也可以是表示父对象宽度的百分比值。</td>
	</tr>
</table>
</div>
...
&lt;asp:Button id=&quot;button1&quot; Text=&quot;Submit&quot; <code>Width=&quot;150px&quot;</code> runat=&quot;server&quot; /&gt;
&lt;/form&gt;</pre>
</div>
