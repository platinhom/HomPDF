...
<!-- Mirrored from www.w3school.com.cn/aspnet/control_htmltablecell.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:12:56 GMT -->
<head>
...
<title>ASP.NET HtmlTableCell 控件</title>
</head>
...
<h1>ASP.NET HtmlTableCell 控件</h1>

<div class="backtoreference">
<p><a href="aspnet_refhtmlcontrols.html" title="HTML 服务器控件">HTML 服务器控件参考手册</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>HtmlTableCell 控件用于控制 &lt;td&gt; 和 &lt;th&gt; 元素。在 HTML 中，这些元素用于创建表格单元格和表头单元格。</p>
</div>
...
<tr>
<td>InnerHtml</td>
<td>设置或返回该 HTML 元素的开始标签和结束标签之间的内容。特殊字符不会被自动转换为 HTML 实体。</td>
</tr>

<tr>
<td>InnerText</td>
<td>设置或返回该 HTML 元素的开始标签和结束标签之间的所有文本。特殊字符会被自动转换为 HTML 实体。</td>
</tr>

<tr>
<td>Nowrap</td>
<td>布尔值，规定该控件内的文本是否换行。</td>
</tr>
...
<tr>
<td>runat</td>
<td>规定该控件是一个服务器控件。必须被设置为 &quot;server&quot;。</td>
</tr>

<tr>
<td>Style</td>
<td>设置或返回被应用到该控件的 CSS 属性。</td>
</tr>
...
<h2>实例</h2>
<dl>
<dt><a target="_blank" href="../tiy/s3201.html?f=demo_aspnet_htmltable_1">HTMLTable</a></dt>
<dd>在本例中,我们在 .aspx 文件中声明了两个 HtmlSelect 控件,一个 HtmlInputButton 控件,以及一个 HtmlTable 控件。用户可选择单元和行的数目。当提交按钮被触发时，会执行 submit 子例程。submit 子例程会根据用户的输入来生成表格。</dd>

<dt><a target="_blank" href="../tiy/s1254.html?f=demo_aspnet_htmltable_2">HTMLTable 2</a></dt>
<dd>在本例中，我们在 .aspx 文件中声明了一个 HtmlTable 控件以及一个 HtmlInputButton 控件。当触发提交按钮时，会执行 submit 子例程。submit 子例程会修改表格的背景颜色和边框颜色，它也会修改单元格的内容。</dd>
</dl>
</div>
