...
<!-- Mirrored from www.w3school.com.cn/aspnet/aspnet_button.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 03:31:31 GMT -->
<head>
...
<li class="currentLink"><a href="aspnet_button.asp" title="WebForms Button">WebForms Button</a></li>
...
<h1>ASP.NET - Button 控件</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="aspnet_textbox.asp" title="WebForms TextBox">WebForms TextBox</a></li>
<li class="next"><a href="aspnet_databinding.html" title="WebForms Data Binding">WebForms 数据绑定</a></li>
</ul>
</div>
...
<p>Button 控件用于显示按钮。按钮可以是提交按钮或命令按钮，而该控件属于提交按钮。</p>
...
<p>Button 控件的属性列在我们的 <a href="control_button.html" title="ASP.NET Button 控件">Button 控件参考手册</a>中。</p>
...
<!-- Mirrored from www.w3school.com.cn/aspnet/aspnet_button.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 03:31:32 GMT -->
</html>