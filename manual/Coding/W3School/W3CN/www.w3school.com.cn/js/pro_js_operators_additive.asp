...
<!-- Mirrored from www.w3school.com.cn/js/pro_js_operators_additive.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:33:49 GMT -->
<head>
<meta charset="gbk" />
...
<li class="currentLink"><a href="pro_js_operators_additive.asp" title="ECMAScript 加性运算符">加性运算符</a></li>
...
<h1>ECMAScript 加性运算符</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="pro_js_operators_multiplicative.html" title="ECMAScript 乘性运算符">乘性运算符</a></li>
<li class="next"><a href="pro_js_operators_relational.html" title="ECMAScript 关系运算符">关系运算符</a></li>
</ul>
</div>


<div>
<p><strong>在多数程序设计语言中，加性运算符（即加号或减号）通常是最简单的数学运算符。</strong></p>
<p><strong>在 ECMAScript 中，加性运算符有大量的特殊行为。</strong></p>
</div>
...
<pre>
var result = 5 + 5;	<span>//两个数字</span>
alert(result);		<span>//输出 &quot;10&quot;</span>
var result2 = 5 + &quot;5&quot;;	<span>//一个数字和一个字符串</span>
alert(result);		<span>//输出 &quot;55&quot;</span>
</pre>
...
<p class="note"><span>注释：</span>如果运算数都是数字，那么执行常规的减法运算，并返回结果。</p>
</div>
