...
<!-- Mirrored from www.w3school.com.cn/js/pro_js_object_oriented.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:02:08 GMT -->
<head>
<meta charset="gbk" />
...
<h2>ECMAScript 对象</h2>
<ul>
<li class="currentLink"><a href="pro_js_object_oriented.asp" title="ECMAScript 面向对象技术">面向对象</a></li>
...
<h1>ECMAScript 面向对象技术</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="pro_js_functions_closures.html" title="ECMAScript 闭包（closure）">闭包（closure）</a></li>
<li class="next"><a href="pro_js_object_working_with.html" title="ECMAScript 对象应用">对象应用</a></li>
</ul>
</div>
