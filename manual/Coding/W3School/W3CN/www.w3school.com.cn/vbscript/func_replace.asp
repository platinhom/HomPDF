...
<!-- Mirrored from www.w3school.com.cn/vbscript/func_replace.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:02:36 GMT -->
<head>
...
<title>VBScript Replace 函数</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>Replace 函数可使用一个字符串替换另一个字符串指定的次数。</p>

<h3>语法</h3>
<pre>Replace(string,find,replacewith[,start[,count[,compare]]])</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>start</td>
    <td>可选的。规定开始位置。默认是 1。</td>
  </tr>
  <tr>
    <td>count</td>
    <td>可选的。规定指定替换的次数。默认是 -1，表示进行所有可能的替换。</td>
  </tr>
  <tr>
    <td>compare</td>
    <td>可选的。规定所使用的字符串比较类型。默认是 0。</td>
  </tr>
</table>
...
<tr>
<td>expression 为零长度</td>
<td>零长度字符串 (&quot;&quot;)。</td>
</tr>

<tr>
<td>expression 为 Null</td>
<td>错误。</td>
</tr>

<tr>
<td>find 参数为零长度</td>
<td>expression 的副本。</td>
</tr>

<tr>
<td>replacewith 参数为零长度</td>
<td>expression 的副本，其中删除了所有由 find 参数指定的内容。</td>
</tr>
...
document.write(Replace(txt,&quot;beautiful&quot;,&quot;horrible&quot;))</pre>
<p>输出：</p>
<pre>This is a horrible day!</pre>
</div>
