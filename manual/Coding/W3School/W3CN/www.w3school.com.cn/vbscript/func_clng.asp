...
<!-- Mirrored from www.w3school.com.cn/vbscript/func_clng.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:02:36 GMT -->
<head>
...
<div>
<h2>定义和用法</h2>
<p>CLng 函数可把表达式转换为长整形（Long）类型。</p>
<p class="note"><span>注释：</span>值必须是介于 -2147483648 与 2147483647 之间的数字。</p>
<p class="note"><span>注释：</span>CLng 不同于 Fix 和 Int 函数删除小数部分， 而是采用四舍五入的方式。 当小数部分正好等于 0.5 时， CLng 函数总是将其四舍五入为最接近该数的偶数。如， 0.5 四舍五入为 0, 以及 1.5 四舍五入为 2 。</p>
