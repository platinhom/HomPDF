...
<!-- Mirrored from www.w3school.com.cn/vbscript/func_log.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:02:36 GMT -->
<head>
...
<div>
<h2>定义和用法</h2>
<p>Log 函数可返回指定数据的自然对数。自然对数是以 e 为底的对数。</p>
<p class="note"><span>注释：</span>不允许使用负值。</p>
<p class="tip"><span>提示：</span>请参阅 Exp 函数。</p>
...
<h2>实例</h2>
<h3>例子 1</h3>
<pre>document.write(Log(38.256783227))</pre>
<p>输出：</p>
<pre>3.64432088381777</pre>
</div>
