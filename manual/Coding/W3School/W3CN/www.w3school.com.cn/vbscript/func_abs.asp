...
<!-- Mirrored from www.w3school.com.cn/vbscript/func_abs.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:02:36 GMT -->
<head>
...
<div>
<h2>定义和用法</h2>
<p>Abs 函数可返回指定的数字的绝对值。</p>
<p class="note"><span>注释：</span>如果 number 参数包含Null，则返回 Null 。</p>
<p class="note"><span>注释：</span>如果 number 参数是一个未初始化的变量，则返回 0 。</p>
