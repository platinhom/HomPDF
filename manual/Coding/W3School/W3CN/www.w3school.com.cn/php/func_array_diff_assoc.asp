...
<!-- Mirrored from www.w3school.com.cn/php/func_array_diff_assoc.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:53:30 GMT -->
<head>
<meta charset="gbk" />
...
<title>PHP array_diff_assoc() 函数</title>
...
<p>array_diff_assoc() 函数返回两个数组的差集数组。该数组包括了所有在被比较的数组中，但是不在任何其他参数数组中的键和值。</p>

<p>和 <a href="func_array_diff.html" title="PHP array_diff() 函数">array_diff() 函数</a> 不同，本函数要求键名和键值都进行比较。返回的数组中键名保持不变。</p>


<h3>语法</h3>
<pre>array_diff_assoc(array1,array2,array3...)</pre>
...
<p class="tip"><span>提示：</span>可用一个或任意多个数组与第一个数组进行比较。</p>

<p class="note"><span>注释：</span>键和值都用于比较。</p>
</div>
