...
<!-- Mirrored from www.w3school.com.cn/php/php_mysql_select.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 03:14:49 GMT -->
<head>
<meta charset="gbk" />
...
<li class="currentLink"><a href="php_mysql_select.asp" title="PHP MySQL Select">MySQL Select</a></li>
...
<h1>PHP MySQL Select</h1>

<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_mysql_insert.html" title="PHP MySQL Insert Into">MySQL Insert</a></li>
<li class="next"><a href="php_mysql_where.html" title="PHP MySQL Where 子句">MySQL Where</a></li>
</ul>
</div>

<div id="intro">
<p><strong>SELECT 语句用于从数据库中选取数据。</strong></p>
</div>
...
<h3>语法</h3>
<pre>SELECT column_name(s) FROM table_name</pre>

<p class="note"><span>注释：</span>SQL 语句对大小写不敏感。SELECT 与 select 等效。</p>
