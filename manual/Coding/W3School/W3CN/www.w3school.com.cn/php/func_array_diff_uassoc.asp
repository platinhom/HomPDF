...
<!-- Mirrored from www.w3school.com.cn/php/func_array_diff_uassoc.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:53:30 GMT -->
<head>
<meta charset="gbk" />
...
<title>PHP array_diff_uassoc() 函数</title>
...
<h1>PHP array_diff_uassoc() 函数</h1>

<div class="backtoreference">
<p><a href="php_ref_array.html" title="PHP Array 函数">PHP Array 函数</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>array_diff_uassoc() 函数使用用户自定义的回调函数 (callback) 做索引检查来计算两个或多个数组的差集。返回一个数组，该数组包括了在 <i>array1</i> 中但是不在任何其他参数数组中的值。</p>

<p>注意，与 <a href="func_array_diff.html" title="PHP array_diff() 函数">array_diff() 函数</a> 不同的是，键名也要进行比较。</p>

<p>参数 function 是用户自定义的用来比较两个数组的函数，该函数必须带有两个参数 - 即两个要进行对比的键名。因此与函数 <a href="func_array_diff_assoc.asp" title="PHP array_diff_assoc() 函数">array_diff_assoc()</a> 的行为正好相反，后者是用内部函数进行比较的。</p>

<p>返回的数组中键名保持不变。</p>


<h3>语法</h3>
<pre>array_diff_uassoc(array1,array2,array3...,function)</pre>
