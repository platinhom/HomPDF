...
<!-- Mirrored from www.w3school.com.cn/php/php_ref_directory.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 03:15:19 GMT -->
<head>
<meta charset="gbk" />
...
<li class="currentLink"><a href="php_ref_directory.asp" title="PHP Directory 函数">PHP Directory</a></li>
...
<h1>PHP Directory 函数</h1>

<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_ref_date.html" title="PHP Date / Time 函数">PHP Date</a></li>
<li class="next"><a href="php_ref_error.html" title="PHP Error 和 Logging 函数">PHP Error</a></li>
</ul>
</div>

<div>
<h2>PHP Directory 简介</h2>

<p>Directory 函数允许您获得关于目录及其内容的信息。</p>
</div>

<div>
<h2>安装</h2>
<p>Directory 函数是 PHP 核心的组成部分。无需安装即可使用这些函数。</p>
</div>

<div>
<h2>PHP Directory 函数</h2>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="func_directory_chdir.html">chdir()</a></td>
    <td>改变当前的目录。</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_directory_chroot.html">chroot()</a></td>
    <td>改变当前进程的根目录。</td>
    <td>4</td>
  </tr>
  <tr>
    <td><a href="func_directory_dir.html">dir()</a></td>
    <td>打开一个目录句柄，并返回一个对象。</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_directory_closedir.html">closedir()</a></td>
    <td>关闭目录句柄。</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_directory_getcwd.html">getcwd()</a></td>
    <td>返回当前目录。</td>
    <td>4</td>
  </tr>
  <tr>
    <td><a href="func_directory_opendir.html">opendir()</a></td>
    <td>打开目录句柄。</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_directory_readdir.html">readdir()</a></td>
    <td>返回目录句柄中的条目。</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_directory_rewinddir.html">rewinddir()</a></td>
    <td>重置目录句柄。</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_directory_scandir.html">scandir()</a></td>
    <td>列出指定路径中的文件和目录。</td>
    <td>5</td>
  </tr>
</table>
...
<!-- Mirrored from www.w3school.com.cn/php/php_ref_directory.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 03:15:39 GMT -->
</html>