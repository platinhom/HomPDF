...
<!-- Mirrored from www.w3school.com.cn/php/func_filesystem_pathinfo.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:53:31 GMT -->
<head>
<meta charset="gbk" />
...
<p>pathinfo() 返回一个关联数组包含有 <i>path</i> 的信息。</p>
...
<p class="note"><span>注释：</span>如果不是要求取得所有单元，则 pathinfo() 函数返回字符串。</p>
