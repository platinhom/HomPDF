...
<!-- Mirrored from www.w3school.com.cn/php/func_xml_parser_set_option.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 07:12:43 GMT -->
<head>
<meta charset="gbk" />
...
<title>PHP xml_parser_set_option() 函数</title>
...
<h1>PHP xml_parser_set_option() 函数</h1>
...
<p>xml_parser_set_option() 函数为 XML 解析器进行选项设置。</p>

<p>如果成功，则返回 true。如果失败，则返回 false。</p>


<h3>语法</h3>
<pre>xml_parser_set_option(parser,option,value)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>option</td>
    <td>
	<p>必需。规定要设置的设置选项名称。可能的值：</p>
	<ul class="listintable">
		<li>XML_OPTION_CASE_FOLDING</li>
		<li>XML_OPTION_SKIP_TAGSTART</li>
		<li>XML_OPTION_SKIP_WHITE</li>
		<li>XML_OPTION_TARGET_ENCODING</li>
	</ul>
	</td>
  </tr>
  <tr>
...
<code>xml_parser_set_option($xmlparser, XML_OPTION_SKIP_WHITE, 1);</code>
