...
<!-- Mirrored from www.w3school.com.cn/php/func_string_chunk_split.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 03:42:53 GMT -->
<head>
<meta charset="gbk" />
...
<title>PHP chunk_split() 函数</title>
...
<p class="tiy"><a target="_blank" href="../tiy/s66ae.html?f=demo_php_func_string_chunk_split">运行实例</a></p>
</div>
...
<p>chunk_split() 函数把字符串分割为一连串更小的部分。</p>

<p class="note"><span>注释：</span>该函数不改变原始字符串。</p>
</div>
...
<pre>chunk_split(<i>string</i>,<i>length</i>,<i>end</i>)</pre>
...
<tr>
<td><i>length</i></td>
<td>可选。数字值，定义字符串块的长度。默认是 76。</td>
</tr>

<tr>
<td><i>end</i></td>
<td>可选。字符串值，定义在每个字符串块末端放置的内容。默认是 \r\n。</td>
</tr>
</table>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/sc909.html?f=demo_php_func_string_chunk_split2">运行实例</a></p>
</div>
...
<!-- Mirrored from www.w3school.com.cn/php/func_string_chunk_split.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 03:42:54 GMT -->
</html>