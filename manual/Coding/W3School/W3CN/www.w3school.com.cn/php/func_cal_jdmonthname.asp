...
<!-- Mirrored from www.w3school.com.cn/php/func_cal_jdmonthname.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:53:30 GMT -->
<head>
<meta charset="gbk" />
...
<title>PHP JDMonthName() 函数</title>
...
<p>JDMonthName() 函数返回指定历法的月份字符串。</p>

<h3>语法</h3>
<pre>jdmonthname(jd,mode)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>mode</td>
    <td>
	<p>可选。定义把儒略日计数转换为哪种历法，以及返回哪种月份名称。模式值：</p>
	<ul class="listintable">
		<li>0 - 格里高里历 (缩写) (Jan, Feb, Mar, ...)</li>
		<li>1 - 格里高里历 (January, February, March, ...)</li>
		<li>2 - 凯撒历 (缩写) (Jan, Feb, Mar, ...)</li>
		<li>3 - 凯撒历 (January, February, March, ...)</li>
		<li>4 - 犹太历 (Tishri, Heshvan, Kislev, ...)</li>
		<li>5 - 法国共和历 (Vendemiaire, Brumaire, Frimaire, ...)</li>
	</ul>
	</td>
  </tr>
</table>
