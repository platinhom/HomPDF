...
<!-- Mirrored from www.w3school.com.cn/php/func_cal_gregoriantojd.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:53:30 GMT -->
<head>
<meta charset="gbk" />
...
<title>PHP GregorianToJD() 函数</title>
...
<p>GregorianToJD() 函数将格利高里历法转换成为儒略日计数。</p>

<h3>语法</h3>
<pre>gregoriantojd(month,day,year)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>year</td>
    <td>可选。合法的范围是 4714 B.C. 到 9999 A.D。</td>
  </tr>
</table>
...
<div>
<h2>提示和注释</h2>
<p>尽管该函数可处理 4714 B.C. 之前的日期，您还是要注意格利高里历法在 1582 年才建立，一些国家甚至更晚才接受它（大不列颠在 1752 年，苏联在 1918 年，希腊在 1923 年）。大部分欧洲国家使用罗马儒略历（公历）先于格利高里历法。</p>
</div>
