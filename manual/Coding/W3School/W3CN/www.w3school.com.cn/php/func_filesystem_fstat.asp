...
<!-- Mirrored from www.w3school.com.cn/php/func_filesystem_fstat.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:53:31 GMT -->
<head>
<meta charset="gbk" />
...
<p>获取由文件指针 handle 所打开文件的统计信息。</p>

<p>该函数返回的数组具有该文件的统计信息，该数组包含以下元素：</p>
...
<p class="tip"><span>提示：</span>本函数与 <a href="func_filesystem_stat.html" title="PHP stat() 函数">stat()</a> 函数相似，不同的是，它是作用于已打开的文件指针而不是文件名。</p>
</div>
