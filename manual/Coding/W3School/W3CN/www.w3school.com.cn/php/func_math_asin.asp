...
<!-- Mirrored from www.w3school.com.cn/php/func_math_asin.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:53:31 GMT -->
<head>
<meta charset="gbk" />
...
<p>asin() 函数返回不同数值的反正弦，返回的结果是介于 -PI/2 与 PI/2 之间的弧度值。</p>
...
<table class="dataintable">
  ...
  <tr>
    <td>x</td>
    <td>必需。一个数，范围在 -1 到 1 之间。</td>
  </tr>
</table>

<h3>说明</h3>

<p>返回 <i>x</i> 的反正弦值，单位是弧度。asin() 是 <a href="func_math_sin.html" title="PHP sin() 函数">sin()</a> 的反函数，它的意思是在 asin() 范围里的每个值都是 a==sin(asin(a))。</p>

<p>如果 <i>x</i> 的值在 -1 到 1 之外，则返回 -1.#IND。如果为 1，则返回 PI/2 的值。</p>
