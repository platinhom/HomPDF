...
<!-- Mirrored from www.w3school.com.cn/php/func_date_gmstrftime.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:53:30 GMT -->
<head>
<meta charset="gbk" />
...
<h1>PHP gmstrftime() 函数</h1>

<div class="backtoreference">
<p><a href="php_ref_date.html" title="PHP Date / Time 函数">PHP Date / Time 函数</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>gmstrftime() 函数根据本地区域设置格式化 GMT/UTC 时间／日期。</p>

<h3>语法</h3>
<pre>gmstrftime(format,timestamp)</pre>
...
<div>
<h2>提示和注释</h2>
<p class="tip"><span>提示：</span>与 <a href="func_date_strftime.html" title="PHP strftime() 函数">strftime()</a> 的行为相同，不同的是返回时间是格林威治标准时（GMT）。</p>
</div>

<div>
<h2>例子</h2>

<p>输出 strftime() 和 gmstrftime() 的结果：</p>
...
<pre>Dec 31 1998 20:00:00
Dec 31 1998 19:00:00
It is Wed on Jan 25, 2006, 11:32:10 time zone: W. Europe Standard Time</pre>
