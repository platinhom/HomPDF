...
<!-- Mirrored from www.w3school.com.cn/php/func_filesystem_rename.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:53:31 GMT -->
<head>
<meta charset="gbk" />
...
<p>rename() 函数重命名文件或目录。</p>

<p>若成功，则该函数返回 true。若失败，则返回 false。</p>


<h3>语法</h3>
<pre>rename(<i>oldname</i>,<i>newname</i>,<i>context</i>)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td><i>oldname</i></td>
    <td>必需。规定要重命名的文件或目录。</td>
  </tr>
  <tr>
    <td><i>newname</i></td>
    <td>必需。规定文件或目录的新名称。</td>
  </tr>
  <tr>
    <td><i>context</i></td>
    <td>可选。规定文件句柄的环境。<i>context</i> 是可修改流的行为的一套选项。</td>
  </tr>
</table>
...
<p class="note"><span>注释：</span>在 PHP 4.3.3 之前，rename() 不能在基于 *nix 的系统中跨磁盘分区重命名文件。</p>

<p class="note"><span>注释：</span>用于 <i>oldname</i> 中的封装协议<em>必须</em>和用于 <i>newname</i> 中的相匹配。</p>

<p class="note"><span>注释：</span>对 <i>context</i> 的支持是 PHP 5.0.0 添加的。</p>
