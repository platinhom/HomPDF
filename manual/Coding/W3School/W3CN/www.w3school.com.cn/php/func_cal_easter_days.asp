...
<!-- Mirrored from www.w3school.com.cn/php/func_cal_easter_days.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 07:12:43 GMT -->
<head>
<meta charset="gbk" />
...
<title>PHP easter_days() 函数</title>
...
<p>easter_days() 函数返回指定年份的复活节与 3 月 21 日之间的天数。</p>

<p>输入一个年份，则计算该年复活节与三月二十一日之间的日期数，若没有输入年份，则以当年计算。这个函数可以用来替代 easter_date() 在 1970-2037 年范围外无法计算的问题。</p>

<h3>语法</h3>
<pre>easter_date(year)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>year</td>
    <td>可选。定义用于计算复活节日期的年份。若省略，使用当年。</td>
  </tr>
  <tr>
    <td>method</td>
    <td>可选。允许你计算机与其它历法的复活节日期。例如，如果设置为 CAL_EASTER_ROMAN，则使用 1582 - 1752 年期间的格利高里历法。</td>
  </tr>
</table>
