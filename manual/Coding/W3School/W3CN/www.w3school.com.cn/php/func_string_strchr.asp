...
<!-- Mirrored from www.w3school.com.cn/php/func_string_strchr.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 03:50:02 GMT -->
<head>
<meta charset="gbk" />
...
<p><a href="php_ref_string.html" title="PHP String 函数">PHP String 函数</a></p>
</div>
...
<p>查找 &quot;world&quot; 在 &quot;Hello world!&quot; 中的第一次出现，并返回此字符串的其余部分：</p>
...
<p class="tiy"><a target="_blank" href="../tiy/sa2aa.html?f=demo_php_func_string_strchr">运行实例</a></p>
</div>
...
<p>strchr() 函数搜索字符串在另一字符串中的第一次出现。</p>

<p>该函数是 strstr() 函数的别名。</p>

<p class="note"><span>注释：</span>该函数是二进制安全的。</p>

<p class="note"><span>注释：</span>该函数对大小写感敏。如需进行不区分大小写的搜索，请使用 <a href="func_string_stristr.html" title="PHP stristr() 函数">stristr()</a> 函数。</p>
</div>
...
<pre>strchr(<i>string</i>,<i>search</i>,<i>before_search</i>);</pre>
...
<td>
<p>必需。规定所搜索的字符串。</p>
<p>如果该参数是数字，则搜索匹配该数字对应的 ASCII 值的字符。</p>
</td>
</tr>

<tr>
<td><i>before_search</i></td>
<td>
<p>可选。默认值为 &quot;false&quot; 的布尔值。</p>
<p>如果设置为 &quot;true&quot;，它将返回 <i>search</i> 参数第一次出现之前的字符串部分。</p>
</td>
</tr>
</table>
</div>
...
<table class="dataintable"> 
<tr>
<td style="width:20%;">返回值：</td>
<td>返回字符串的其余部分（从匹配点）。如果未找到所搜索的字符串，则返回 FALSE。</td>
</tr>
...
<tr>
<td>更新日志：</td>
<td>在 PHP 5.3 中，新增了 <i>before_search</i> 参数。</td>
</tr>
</table>
</div>
...
<p>通过 &quot;o&quot; 的 ASCII 值搜索字符串，并返回字符串的其余部分：</p>
...
<p class="tiy"><a target="_blank" href="../tiy/scce6.html?f=demo_php_func_string_strchr_1">运行实例</a></p>


<h3>例子 2</h3>

<p>返回 &quot;world&quot; 第一次出现之前的字符串部分：</p>
...
<p class="tiy"><a target="_blank" href="../tiy/sddd9.html?f=demo_php_func_string_strchr_2">运行实例</a></p>
</div>
...
<!-- Mirrored from www.w3school.com.cn/php/func_string_strchr.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 03:50:03 GMT -->
</html>