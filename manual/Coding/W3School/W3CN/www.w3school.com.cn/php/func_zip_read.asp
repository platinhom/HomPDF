...
<!-- Mirrored from www.w3school.com.cn/php/func_zip_read.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:53:33 GMT -->
<head>
<meta charset="gbk" />
...
<p>zip_read() 函数读取打开的 zip 档案中的下一个文件。</p>

<p>如果成功，则返回包含 zip 档案中一个文件的资源。如果没有更多的项目可供读取，则返回 false。</p>


<h3>语法</h3>
<pre>zip_read(zip)</pre>
...
<p class="tip"><span>提示：</span>由 zip_read() 函数返回的资源可供 zip_entry... 类的函数使用。</p>
</div>
