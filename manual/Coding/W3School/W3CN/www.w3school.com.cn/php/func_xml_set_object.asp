...
<!-- Mirrored from www.w3school.com.cn/php/func_xml_set_object.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 07:12:43 GMT -->
<head>
<meta charset="gbk" />
...
<title>PHP xml_set_object() 函数</title>
...
<p>xml_set_object() 函数允许在对象中使用 XML 解析器。</p>


<h3>语法</h3>
<pre>xml_set_object(parser,object)</pre>
...
<p>该函数使得 <i>parser</i> 指定的解析器可以被用在 <i>object</i> 对象中。所有的回叫函数（callback function）都可以由 xml_set_element_handler() 等函数来设置，它们被假定为 <i>object</i> 对象的方法。</p>
...
function XMLParser()
  ...
  <code>xml_set_object($this-&gt;xmlparser, $this);</code>
