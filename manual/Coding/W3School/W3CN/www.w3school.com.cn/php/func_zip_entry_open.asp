...
<!-- Mirrored from www.w3school.com.cn/php/func_zip_entry_open.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:53:33 GMT -->
<head>
<meta charset="gbk" />
...
<title>PHP zip_entry_open() 函数</title>
...
<h1>PHP zip_entry_open() 函数</h1>

<div class="backtoreference">
<p><a href="php_ref_zip.html" title="PHP Zip File 函数">PHP Zip File 函数</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>zip_entry_open() 函数打开一个 ZIP 档案项目以供读取。</p>


<h3>语法</h3>
<pre>zip_entry_open(zip,zip_entry,mode)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>zip</td>
    <td>必需。规定要读取的 zip 资源（由 zip_open() 打开的 zip 文件）。</td>
  </tr>
  <tr>
    <td>zip_entry</td>
    <td>必需。规定要打开的 zip 项目资源（由 zip_read() 打开的 zip 项目）。</td>
  </tr>
  <tr>
    <td>mode</td>
    <td>可选。规定 zip 档案项目的访问类型。</td>
  </tr>
</table>

<h3>说明</h3>

<p>在 PHP 5 中，mode 会被忽略，且总为 &quot;rb&quot;。这是因为在 PHP 中的 zip 支持是只读的。</p>
...
if ($zip)
  ...
  while ($zip_entry = zip_read($zip))
    ...
    if (<code>zip_entry_open($zip, $zip_entry)</code>)
      {
      // some code
      }
    echo &quot;&lt;/p&gt;&quot;;
