...
<!-- Mirrored from www.w3school.com.cn/php/filter_validate_int.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:53:31 GMT -->
<head>
<meta charset="gbk" />
...
<title>PHP FILTER_VALIDATE_INT 过滤器</title>
...
<h1>PHP FILTER_VALIDATE_INT 过滤器</h1>

<div class="backtoreference">
<p><a href="php_ref_filter.html" title="PHP Filter 函数">PHP Filter 函数</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>FILTER_VALIDATE_INT 过滤器以整数验证值。</p>
...
<ul>
	<li>min_range - 规定最小整数值</li>
	<li>max_range - 规定最大整数值</li>
	<li>FILTER_FLAG_ALLOW_OCTAL - 允许八进制数值</li>
	<li>FILTER_FLAG_ALLOW_HEX - 允许十六进制数值</li>
</ul>
...
<p class="note"><span>注释：</span>当在数组中规定选项时，选项必须存入一个名为 &quot;options&quot; 的关联多维数组中。请看下面的例子。</p>
</div>
...
var_dump(filter_var($var, <code>FILTER_VALIDATE_INT</code>, $int_options));
?&gt;</pre>
