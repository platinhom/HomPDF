...
<!-- Mirrored from www.w3school.com.cn/php/php_ref_xml.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 03:16:45 GMT -->
<head>
<meta charset="gbk" />
...
<li class="currentLink"><a href="php_ref_xml.asp" title="PHP XML Parser 函数">PHP XML</a></li>
...
<h1>PHP XML Parser 函数</h1>

<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="php_ref_string.html" title="PHP String 函数">PHP String</a></li>
<li class="next"><a href="php_ref_zip.html" title="PHP Zip File 函数">PHP Zip</a></li>
</ul>
</div>
...
<p>XML 函数允许我们解析 XML 文档，但无法对其进行验证。</p>

<p>XML 是一种用于标准结构化文档交换的数据格式。您可以在我们的 <a href="../xml/index.html" title="XML 教程">XML 教程</a> 中找到更多有关 XML 的信息。</p>
...
<p>由于它基于事件，且无验证，Expat 具有快速并适合 web 应用程序的特性。</p>

<p>XML 解析器函数允许我们创建 XML 解析器，并为 XML 事件定义句柄。</p>

</div>

<div>
<h2>安装</h2>
<p>XML 函数是 PHP 核心的组成部分。无需安装即可使用这些函数。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="func_xml_utf8_decode.html">utf8_decode()</a></td>
    <td>把 UTF-8 字符串解码为 ISO-8859-1。</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_xml_utf8_encode.html">utf8_encode()</a></td>
    <td>把 ISO-8859-1 字符串编码为 UTF-8。</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_xml_error_string.html">xml_error_string()</a></td>
    <td>获取 XML 解析器的错误描述。</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_xml_get_current_byte_index.html">xml_get_current_byte_index()</a></td>
    <td>获取 XML 解析器的当前字节索引。</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_xml_get_current_column_number.html">xml_get_current_column_number()</a></td>
    <td>获取 XML 解析器的当前列号。</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_xml_get_current_line_number.html">xml_get_current_line_number()</a></td>
    <td>获取 XML 解析器的当前行号。</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_xml_get_error_code.html">xml_get_error_code()</a></td>
    <td>获取 XML 解析器错误代码。</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_xml_parse.html">xml_parse()</a></td>
    <td>解析 XML 文档。</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_xml_parse_into_struct.html">xml_parse_into_struct()</a></td>
    <td>把 XML 数据解析到数组中。</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_xml_parser_create_ns.html">xml_parser_create_ns()</a></td>
    <td>创建带有命名空间支持的 XML 解析器。</td>
    <td>4</td>
  </tr>
	<tr>
    <td><a href="func_xml_parser_create.html">xml_parser_create()</a></td>
    <td>创建 XML 解析器。</td>
    <td>3</td>
  </tr>
	<tr>
    <td><a href="func_xml_parser_free.html">xml_parser_free()</a></td>
    <td>释放 XML 解析器。</td>
    <td>3</td>
  </tr>
	<tr>
    <td><a href="func_xml_parser_get_option.html">xml_parser_get_option()</a></td>
    <td>从 XML 解析器获取选项设置信息。</td>
    <td>3</td>
  </tr>
	<tr>
    <td><a href="func_xml_parser_set_option.asp">xml_parser_set_option()</a></td>
    <td>为 XML 解析进行选项设置。</td>
    <td>3</td>
  </tr>
	<tr>
    <td><a href="func_xml_set_character_data_handler.html">xml_set_character_data_handler()</a></td>
    <td>建立字符数据处理器。</td>
    <td>3</td>
  </tr>
	<tr>
    <td><a href="func_xml_set_default_handler.html">xml_set_default_handler()</a></td>
    <td>建立默认的数据处理器。</td>
    <td>3</td>
  </tr>
	<tr>
    <td><a href="func_xml_set_element_handler.html">xml_set_element_handler()</a></td>
    <td>建立起始和终止元素处理器。</td>
    <td>3</td>
  </tr>
	<tr>
    <td>xml_set_end_namespace_decl_handler()</td>
    <td>建立终止命名空间声明处理器。</td>
    <td>4</td>
  </tr>
	<tr>
    <td><a href="func_xml_set_external_entity_ref_handler.html">xml_set_external_entity_ref_handler()</a></td>
    <td>建立外部实体处理器。</td>
    <td>3</td>
  </tr>
	<tr>
    <td><a href="func_xml_set_notation_decl_handler.asp">xml_set_notation_decl_handler()</a></td>
    <td>建立注释声明处理器。</td>
    <td>3</td>
  </tr>
	<tr>
    <td><a href="func_xml_set_object.asp">xml_set_object()</a></td>
    <td>在对象中使用 XML 解析器。</td>
    <td>4</td>
  </tr>
	<tr>
    <td><a href="func_xml_set_processing_instruction_handler.html">xml_set_processing_instruction_handler()</a></td>
    <td>建立处理指令（PI）处理器。</td>
    <td>3</td>
  </tr>
	<tr>
    <td>xml_set_start_namespace_decl_handler()</td>
    <td>建立起始命名空间声明处理器。</td>
    <td>4</td>
  </tr>
  <tr>
    <td><a href="func_xml_set_unparsed_entity_decl_handler.html">xml_set_unparsed_entity_decl_handler()</a></td>
    <td>建立未解析实体定义声明处理器。</td>
    <td>3</td>
  </tr>
</table>
</div>
...
<!-- Mirrored from www.w3school.com.cn/php/php_ref_xml.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 03:18:21 GMT -->
</html>