...
<!-- Mirrored from www.w3school.com.cn/php/func_string_strncmp.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 03:55:06 GMT -->
<head>
<meta charset="gbk" />
...
<p class="tiy"><a target="_blank" href="../tiy/sb702.html?f=demo_php_func_string_strncmp">运行实例</a></p>
</div>
...
<p>strncmp() 函数比较两个字符串。</p>

<p class="note"><span>注释：</span>strncmp() 是二进制安全的，且对大小写敏感。</p>

<p class="tip"><span>提示：</span>该函数与 <a href="func_string_strcmp.html" title="PHP strcmp() 函数">strcmp()</a> 函数类似，不同的是，strcmp() 没有 <i>length</i> 参数。 </p>
</div>
...
<pre>strncmp(<i>string1</i>,<i>string2</i>,<i>length</i>)</pre>
...
<li>0 - 如果两个字符串相等</li>
<li>&lt;0 - 如果 <i>string1</i> 小于 <i>string2</i></li>
<li>&gt;0 - 如果 <i>string1</i> 大于 <i>string2</i></li>
</ul>
</td>
</tr>
...
<p>比较两个字符串（区分大小写，China 和 CHINA 输出不相同）： </p>
...
<p class="tiy"><a target="_blank" href="../tiy/s76de.html?f=demo_php_func_string_strncmp_1">运行实例</a></p>
</div>
...
<!-- Mirrored from www.w3school.com.cn/php/func_string_strncmp.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 03:55:07 GMT -->
</html>