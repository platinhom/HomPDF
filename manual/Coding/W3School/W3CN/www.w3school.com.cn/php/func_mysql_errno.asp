...
<!-- Mirrored from www.w3school.com.cn/php/func_mysql_errno.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:53:31 GMT -->
<head>
<meta charset="gbk" />
...
<title>PHP mysql_errno() 函数</title>
...
<h1>PHP mysql_errno() 函数</h1>

<div class="backtoreference">
<p><a href="php_ref_mysql.html" title="PHP MySQL 函数">PHP MySQL 函数</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>mysql_errno() 函数返回上一个 MySQL 操作中的错误信息的数字编码。</p>

<p>返回上一个 MySQL 函数的错误号码，如果没有出错则返回 0（零）。</p>


<h3>语法</h3>
<pre>mysql_errno(connection)</pre>
...
<p>在本例中，我们将尝试使用错误的用户名和密码来登录一个 MySQL 服务器：</p>

<pre>&lt;?php
$con = mysql_connect(&quot;localhost&quot;,&quot;wrong_user&quot;,&quot;wrong_pwd&quot;);
if (!$con)
  {
  die('Could not connect: ' . <code>mysql_errno()</code>);
  }
mysql_close($con);
?&gt;</pre>
...
<pre>Could not connect: 1045</pre>
