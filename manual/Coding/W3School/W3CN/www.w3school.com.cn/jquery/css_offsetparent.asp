...
<!-- Mirrored from www.w3school.com.cn/jquery/css_offsetparent.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:46:42 GMT -->
<head>
<meta charset="gbk" />
...
<title>jQuery CSS 操作 - offsetParent() 方法</title>
</head>
...
<h1>jQuery CSS 操作 - offsetParent() 方法</h1>

<div class="backtoreference">
<p><a href="jquery_ref_css.html" title="jQuery 参考手册 - CSS 操作">jQuery CSS 操作参考手册</a></p>
</div>
...
<p>设置最近的祖先定位元素的背景颜色：</p>

<pre>
$(&quot;button&quot;).click(function(){
  $(&quot;p&quot;).<code>offsetParent()</code>.css(&quot;background-color&quot;,&quot;red&quot;);
});
</pre>

<p class="tiy"><a target="_blank" href="../tiy/tae6f.html?f=jquery_css_offsetparent">亲自试一试</a></p>
</div>
...
<p>offsetParent() 方法返回最近的祖先定位元素。</p>

<p>定位元素指的是元素的 CSS position 属性被设置为 relative、absolute 或 fixed 的元素。</p>

<p>可以通过 jQuery 设置 position，或者通过 CSS 的 position 属性。</p>


<h3>语法</h3>

<pre>$(<i>selector</i>).offsetParent()</pre>
</div>
...
<!-- Mirrored from www.w3school.com.cn/jquery/css_offsetparent.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:46:43 GMT -->
</html>