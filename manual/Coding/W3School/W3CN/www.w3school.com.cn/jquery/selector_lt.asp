...
<!-- Mirrored from www.w3school.com.cn/jquery/selector_lt.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:34:58 GMT -->
<head>
<meta charset="gbk" />
...
<p class="tiy"><a target="_blank" href="../tiy/t7200.html?f=jquery_selector_lt">亲自试一试</a></p>
</div>
...
<p>:lt 选择器选取带有小于指定 index 值的元素。</p>

<p>index 值从 0 开始。</p>

<p>经常与其他元素/选择器一起使用，来选择指定的组中特定序号之前的元素（如上面的例子）。</p>

<h3>语法</h3>

<pre>$(&quot;:lt(<i>index</i>)&quot;)</pre>
...
<p class="tip"><span>提示：</span>请使用 <a href="selector_gt.html" title="jQuery :gt 选择器">:gt 选择器</a>来选取 index 值大于指定数的元素。</p>
</div>
