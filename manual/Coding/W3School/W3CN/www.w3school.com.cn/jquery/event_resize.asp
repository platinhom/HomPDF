...
<!-- Mirrored from www.w3school.com.cn/jquery/event_resize.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:39:27 GMT -->
<head>
<meta charset="gbk" />
...
<title>jQuery 事件 - resize() 方法</title>
</head>
...
<h1>jQuery 事件 - resize() 方法</h1>

<div class="backtoreference">
<p><a href="jquery_ref_events.html" title="jQuery 参考手册 - 事件">jQuery 事件参考手册</a></p>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/t507e.html?f=jquery_event_resize">亲自试一试</a></p>
</div>
...
<pre>$(<i>selector</i>).resize()</pre>

<p class="tiy"><a target="_blank" href="../tiy/tf6da.html?f=jquery_event_resize_trigger">亲自试一试</a></p>
</div>


<div>
<h2>将函数绑定到 resize 事件</h2>

<h3>语法</h3>

<pre>$(<i>selector</i>).resize(<i>function</i>)</pre>
...
<tr>
<td><i>function</i></td>
<td>可选。规定当发生 resize 事件时运行的函数。</td>
</tr>
</table>
...
<!-- Mirrored from www.w3school.com.cn/jquery/event_resize.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:39:28 GMT -->
</html>