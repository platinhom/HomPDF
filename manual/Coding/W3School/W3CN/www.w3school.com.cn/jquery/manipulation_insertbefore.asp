...
<!-- Mirrored from www.w3school.com.cn/jquery/manipulation_insertbefore.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:42:27 GMT -->
<head>
<meta charset="gbk" />
...
<title>jQuery 文档操作 - insertBefore() 方法</title>
</head>
...
<h1>jQuery 文档操作 - insertBefore() 方法</h1>
...
<p class="tiy"><a target="_blank" href="../tiy/t89b4.html?f=jquery_manipulation_insertbefore">亲自试一试</a></p>
</div>
...
<p>insertBefore() 方法在被选元素之前插入 HTML 标记或已有的元素。</p>

<p class="note"><span>注释：</span>如果该方法用于已有元素，这些元素会被从当前位置移走，然后被添加到被选元素之前。</p>

<h3>语法</h3>

<pre>$(<i>content</i>).insertBefore(<i>selector</i>)</pre>
...
<dl>
<dt><a target="_blank" href="../tiy/tad8f.html?f=jquery_manipulation_insertbefore_selector">插入已有的元素</a></dt>
<dd>如何使用 insertAfter() 方法在每个被选元素之前插入已存在的元素。</dd>
</dl>
</div>
...
<!-- Mirrored from www.w3school.com.cn/jquery/manipulation_insertbefore.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:42:28 GMT -->
</html>