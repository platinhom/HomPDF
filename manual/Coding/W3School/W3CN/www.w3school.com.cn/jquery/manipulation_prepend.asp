...
<!-- Mirrored from www.w3school.com.cn/jquery/manipulation_prepend.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:42:28 GMT -->
<head>
<meta charset="gbk" />
...
<title>jQuery 文档操作 - prepend() 方法</title>
</head>
...
<h1>jQuery 文档操作 - prepend() 方法</h1>

<div class="backtoreference">
<p><a href="jquery_ref_manipulation.html" title="jQuery 参考手册 - 文档操作">jQuery 文档操作参考手册</a></p>
</div>
...
<pre>
$(&quot;.btn1&quot;).click(function(){
  $(&quot;p&quot;).<code>prepend(&quot;&lt;b&gt;Hello world!&lt;/b&gt;&quot;)</code>;
});
</pre>

<p class="tiy"><a target="_blank" href="../tiy/t1684.html?f=jquery_manipulation_prepend">亲自试一试</a></p>
</div>
...
<p class="tip"><span>提示：</span>prepend() 和 <a href="manipulation_perpendto.html" title="jQuery 文档操作 - prependTo() 方法">prependTo()</a> 方法作用相同。差异在于语法：内容和选择器的位置，以及 prependTo() 无法使用函数来插入内容。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).prepend(<i>content</i>)</pre>
...
<p>使用函数在被选元素的开头插入指定的内容。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).prepend(<i>function(index,html)</i>)</pre>

<p class="tiy"><a target="_blank" href="../tiy/t7002.html?f=jquery_manipulation_prepend_function">亲自试一试</a></p>
...
<tr>
<td><i>function(index,html)</i></td>
<td>
	<p>必需。规定返回待插入内容的函数。</p>
	<ul class="listintable">
	<li>index - 可选。接受选择器的 index 位置。</li>
	<li>html - 可选。接受选择器的当前 HTML。</li>
	</ul>
</td>
<tr>
</table>
...
<!-- Mirrored from www.w3school.com.cn/jquery/manipulation_prepend.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:42:29 GMT -->
</html>