...
<!-- Mirrored from www.w3school.com.cn/jquery/traversing_is.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:51:09 GMT -->
<head>
<meta charset="gbk" />
...
<p class="tiy"><a target="_blank" href="../tiy/t8110.html?f=jquery_traversing_is">亲自试一试</a></p>
</div>
...
<p>与其他筛选方法不同，.is() 不创建新的 jQuery 对象。相反，它允许我们在不修改 jQuery 对象内容的情况下对其进行检测。这在 callback 内部通常比较有用，比如事件处理程序。</p>
...
<p class="tiy"><a target="_blank" href="../tiy/td5cb.html?f=jquery_traversing_is_2">亲自试一试</a></p>
...
<p>请您注意，对于带有位置性选择器的选择器表达式字符串，比如 :first、:gt() 或者 :even，位置性筛选是针对传递到 .is() 的 jQuery 对象进行的，而非针对包含文档。所以对于上面的 HTML 来说，诸如 $(&quot;li:first&quot;).is(&quot;li:last&quot;) 的表达式返回 true，但是 $(&quot;li:first-child&quot;).is(&quot;li:last-child&quot;) 返回 false。</p>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/tf847.html?f=jquery_traversing_is_3">亲自试一试</a></p>
</div>
...
<!-- Mirrored from www.w3school.com.cn/jquery/traversing_is.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:51:11 GMT -->
</html>