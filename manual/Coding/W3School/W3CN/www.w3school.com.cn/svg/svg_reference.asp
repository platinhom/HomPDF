...
<!-- Mirrored from www.w3school.com.cn/svg/svg_reference.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 03:31:22 GMT -->
<head>
...
<h2>SVG 参考</h2>
<ul>
<li class="currentLink"><a href="svg_reference.asp" title="SVG 参考手册">SVG 元素</a></li>
</ul>
</div><div id="selected">
<h2>建站手册</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="svg_examples.asp" title="SVG 实例">SVG 实例</a></li>
<li class="next"><a href="index.html" title="SVG 教程">SVG 教程</a></li>
</ul>
</div>

<div>
<p><strong>来自 W3C 推荐标准 (SVG Version 1.1) 的 SVG 元素</strong></p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td>altGlyph</td>
    <td>允许对象性文字进行控制，来呈现特殊的字符数据（例如，音乐符号或亚洲的文字）</td>
  </tr>
  <tr>
    <td>altGlyphDef</td>
    <td>定义一系列象性符号的替换（例如，音乐符号或者亚洲文字）</td>
  </tr>
  <tr>
    <td>altGlyphItem</td>
  ...
  <tr>
    <td>feBlend</td>
    <td>SVG 滤镜。使用不同的混合模式把两个对象合成在一起。</td>
  </tr>
  <tr>
    <td>feColorMatrix</td>
    <td>SVG 滤镜。应用matrix转换。</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>SVG 滤镜。 Defines a light source</td>
  </tr>
  <tr>
    <td>feFlood</td>
    <td>SVG 滤镜。</td>
