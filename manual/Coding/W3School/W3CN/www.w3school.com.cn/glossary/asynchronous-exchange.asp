...
<!-- Mirrored from www.w3school.com.cn/glossary/asynchronous-exchange.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:02:38 GMT -->
<head>
...
<title>W3C 术语 - asynchronous exchange</title>
</head>
...
<h1>W3C 术语 - asynchronous exchange</h1>
...
<div>
<h2>asynchronous exchange</h2>

<p class="chinese"><span>中文：</span>异步交换</p>

<h3>解释</h3>
<p>在异步服务响应的位置发生的未完成的交互，要求客户机在稍后的时间执行并发的请求。例如，当客户机注册需要耗时的校验时，对其来说稍后回来获得完整的响应更实际一些。例如对于 XML Key Management，所有产生异步结果的请求必须生成指示非完成响应的同步响应状态，比如“挂起”。这些响应可能还会为客户机提供一个 URL 来向后校验，以便稍后获得完整的响应。</p>

<h3>来源</h3>
<p>
来自：<a href="http://www.w3.org/TR/xkms2-req">XML Key Management (XKMS 2.0) Requirements</a> 
(<a href="http://www.w3.org/TR/2003/NOTE-xkms2-req-20030505">2003-05-05</a>)
</p>
<p><a href="http://www.w3.org/2003/glossary/subglossary/xkms2-req/">该来源中的术语</a></p>
</div>
