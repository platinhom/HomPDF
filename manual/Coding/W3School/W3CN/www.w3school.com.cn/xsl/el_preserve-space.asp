...
<!-- Mirrored from www.w3school.com.cn/xsl/el_preserve-space.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:02:37 GMT -->
<head>
...
<title>XSLT &lt;xsl:preserve-space&gt; 和 &lt;xsl:strip-space&gt; 元素</title>
</head>
...
<h1>XSLT &lt;xsl:preserve-space&gt; 和 &lt;xsl:strip-space&gt; 元素</h1>
...
<p>&lt;xsl:preserve-space&gt; 元素用于定义保留空白的元素。</p>
<p>&lt;xsl:strip-space&gt; 元素用于定义删除空白的元素。</p>
<p class="note"><span>注释：</span>保留空白是默认的设置，所以只有当使用 &lt;xsl:strip-space&gt; 元素使才有必要使用 &lt;xsl:preserve-space&gt; 元素。</p>
<p class="note"><span>注释：</span>&lt;xsl:preserve-space&gt;  元素和 &lt;xsl:strip-space&gt; 元素都是顶层元素（top-level element）。</p>
</div>
...
<td>
<p>必需。一个空格分隔的元素列表，规定了保留/删除空白的元素。</p>
<p>注释：列表中可包含 &quot;*&quot; 和 &quot;prefix:*&quot;，这样就可以加入所有元素或来自特定命名空间的所有元素。</p></td>
</tr>
</table>
</div>
...
<h3>例子 1</h3>
<p>在本例中，我们为 title 和 artist 元素预留了空白节点，并从 country、company、price 以及 year 元素删除了空白节点：</p>
