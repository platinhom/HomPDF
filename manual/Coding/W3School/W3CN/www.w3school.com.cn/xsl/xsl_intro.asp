...
<!-- Mirrored from www.w3school.com.cn/xsl/xsl_intro.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 03:30:03 GMT -->
<head>
...
<li class="currentLink"><a href="xsl_intro.asp" title="XSLT 简介">XSLT 简介</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="xsl_languages.html" title="XSLT 语言">XSLT 语言</a></li>
<li class="next"><a href="xsl_browsers.html" title="对 XSLT 的浏览器支持">XSLT 浏览器</a></li>
</ul>
</div>

<div id="intro">
<p><strong>XSLT 是一种用于将 XML 文档转换为 XHTML 文档或其他 XML 文档的语言。</strong></p>
<p><strong>XPath 是一种用于在 XML 文档中进行导航的语言。</strong></p>
</div>

<div>
<h2>学习之前，您需要具备的基础知识：</h2>
<p>在您继续学习之前，需要对以下知识有基本的了解：</p>
<ul>
<li>HTML / XHTML</li>
<li>XML / XML 命名空间</li>
<li>XPath</li>
</ul>
<p>如果您希望首先学习这些项目，请在我们的 <a href="../index-2.html" title="W3School 在线教程 ">首页</a> 访问这些教程。</p>
</div>
...
<ul>
<li>XSLT 指 XSL 转换（XSL Transformations）。</li>
<li>XSLT 是 XSL 中最重要的部分。</li>
<li>XSLT 可将一种 XML 文档转换为另外一种 XML 文档。</li>
<li>XSLT 使用 XPath 在 XML 文档中进行导航。</li>
...
<div>
<h2>XSLT = XSL 转换</h2>
<p>XSLT 是 XSL 中最重要的部分。</p>
<p>XSLT 用于将一种 XML 文档转换为另外一种 XML 文档，或者可被浏览器识别的其他类型的文档，比如 HTML 和 XHTML。通常，XSLT 是通过把每个 XML 元素转换为 (X)HTML 元素来完成这项工作的。</p>
<p>通过 XSLT，您可以向或者从输出文件添加或移除元素和属性。您也可重新排列元素，执行测试并决定隐藏或显示哪个元素，等等。</p>
<p>描述转化过程的一种通常的说法是，<em>XSLT 把 XML 源树转换为 XML 结果树</em>。</p>
</div>

<div>
<h2>XSLT 使用 XPath</h2>
<p>XSLT 使用 XPath 在 XML 文档中查找信息。XPath 被用来通过元素和属性在 XML 文档中进行导航。</p>
<p>如果您希望首先学习 XPath，请访问我们的 <a href="../xpath/index.html" title="XPath教程">XPath 教程</a>。</p>
</div>

<div>
<h2>它如何工作？</h2>
<p>在转换过程中，XSLT 使用 XPath 来定义源文档中可匹配一个或多个预定义模板的部分。一旦匹配被找到，XSLT 就会把源文档的匹配部分转换为结果文档。</p>
</div>

<div>
<h2>XSLT 是 W3C 标准</h2>
<p>XSLT 在 1999 年 11 月 16 日被确立为 W3C 标准。</p>
<p>如需更多有关 W3C 的 XSLT 活动的信息，请访问我们的 <a href="../w3c/w3c_xsl.html" title="W3C XSL 活动">W3C 教程</a>。</p>
</div>
