...
<!-- Mirrored from www.w3school.com.cn/xslfo/index.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Dec 2015 22:49:16 GMT -->
<head>
...
<ul>
<li class="currentLink"><a href="index.asp" title="XSL-FO 教程">XSLFO 教程</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="index.asp" title="XSL-FO 教程">XSLFO 教程</a></li>
<li class="next"><a href="xslfo_intro.html" title="XSL-FO 简介">XSLFO 简介</a></li>
</ul>
</div>

<div>
<p><strong>在我们的 XSL-FO 教程中，您将了解到什么是 XSL-FO。</strong></p>
<p><strong>您将学习如何使用 XSL-FO 对用于输出的XML文档进行格式化。</strong></p>
<p><a href="xslfo_intro.html" title="XSL-FO 简介">开始学习 XSL-FO</a>！</p>
</div>

<div id="toc">
<h2>内容目录</h2>
<dl>
<dt><a href="xslfo_intro.html" title="XSL-FO简介">XSL-FO 简介</a></dt>
<dd>XSL-FO 的简介。包括其概念和作用。</dd>
<dt><a href="xslfo_documents.html" title="XSL-FO文档">XSL-FO 文档</a></dt>
<dd>本章将解 XSL-FO 文档的结构。</dd>
<dt><a href="xslfo_areas.html" title="XSL-FO Areas">XSL-FO 区域</a></dt>
<dd>本章讲解 XSL-FO 的区域模型（area model）。</dd>
<dt><a href="xslfo_output.html" title="XSLFO Output">XSL-FO 输出</a></dt>
<dd>本章讲解 XSL-FO 文档的输出元素（Output Elements）。</dd>
<dt><a href="xslfo_flow.html" title="XSLFO Flow">XSL-FO 流</a></dt>
<dd>本章讲解 XSL-FO 文档的输出流（Output Flow）。</dd>
<dt><a href="xslfo_pages.html" title="XSLFO页面">XSL-FO 页</a></dt>
<dd>本章讲解 XSL-FO 如何定义页面的布局。</dd>
<dt><a href="xslfo_blocks.html" title="XSL-FO Blocks">XSL-FO 块</a></dt>
<dd>本章讲解 XSL-FO 输出块（output blocks）。</dd>
<dt><a href="xslfo_lists.html" title="XSL-FO列表">XSL-FO 列表</a></dt>
<dd>本章讲解 XSL-FO 如何定义列表。</dd>
<dt><a href="xslfo_tables.asp" title="XSL-FO表格">XSL-FO 表格</a></dt>
<dd>本章讲解 XSL-FO 如何定义表格。</dd>
<dt><a href="xslfo_xslt.html" title="XSL-FO与XSLT的关系">XSL-FO 和 XSLT</a></dt>
<dd>本章讲解 XSL-FO 如何使用 XSLT。</dd>
<dt><a href="xslfo_reference.html" title="XSL-FO对象参考手册">XSL-FO 对象参考手册</a></dt>
<dd>完整的 XSL-FO 对象列表，以及它们的属性。</dd>
</dl>
</div>
