...
<!-- Mirrored from www.w3school.com.cn/media/media_intro.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 03:32:44 GMT -->
<head>
...
<li class="currentLink"><a href="media_intro.asp" title="Web 多媒体 简介">媒介简介</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="index.html" title="网络多媒体 教程">媒体教程</a></li>
<li class="next"><a href="media_soundformats.html" title="多媒体 音频格式">音频格式</a></li>
</ul>
</div>

<div id="intro">
<p><strong>多媒体（Multimedia）指图片、声音、音乐、动画和视频。</strong></p>
<p><strong>现代的 web 浏览器支持多种多媒体格式。</strong></p>
</div>

<div>
<h2>什么是多媒体？</h2>
<p>多媒体是我们可以看到和听到的一切：文本、书籍、图片、音乐、声音、CD、视频、DVD、档案、电影等等。</p>
<p>多媒体以多种方式存在。在因特网上，您会发现很多被嵌入网页中的元素，并且今天的 web 浏览器已支持多种多媒体格式。</p>
<p>在本教程中，您会学到不同的多媒体格式，以及如何您的网页中使用它们。</p>
</div>

<div>
<h2>浏览器支持</h2>
<p>第一批因特网浏览器仅支持文本，甚至被限制为单一颜色的单一字体。</p>
<p>随后的 web 浏览器支持色彩、字体以及文本样式，并增加了对图像的支持。</p>
<p>不同的浏览器对声音、动画以及视频的处理方式是各不相同的。某些元素被内联处理，某些要求插件，而某些则要求 ActiveX 控件。</p>
<p>您将在下面的章节学到这方面的知识。</p>
</div>

<div>
<h2>多媒体格式</h2>
<p>多媒体元素（比如声音或视频）被存储在媒体文件中。</p>
<p>识别媒介类型的最通用的方法是查看文件的扩展名。</p>
<p>当浏览器获知文件的后缀是 .htm 或者 .html，它将假定文件是 HTML 页面。.xml 后缀表示 XML 文件，而 .CSS 后缀表示样式表。</p>
<p>图像格式是通过 .gif 或 .jpeg 后缀来识别的。</p>
<p>多媒体元素同样拥有带有不同后缀的文件格式。</p>
<p>在下面的章节，您将学到更多有关媒体文件后缀的知识。</p>
</div>
