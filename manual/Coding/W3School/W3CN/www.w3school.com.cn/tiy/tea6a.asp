...
<!-- Mirrored from www.w3school.com.cn/tiy/t.asp?f=hdom_iframe_frameborder by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 07:33:29 GMT -->
...
<input type="button" onclick="restoreBorder()" value="Restore border" />
...
<div id="result">
<h2>查看结果:</h2>
<iframe frameborder="0" name="i" src="loadtextea6a.html?f=hdom_iframe_frameborder"></iframe>
</div>
