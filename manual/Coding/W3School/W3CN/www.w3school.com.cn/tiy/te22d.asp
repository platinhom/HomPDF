...
<!-- Mirrored from www.w3school.com.cn/tiy/t.asp?f=hdom_style_scrollbarhighlightcolor by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 07:28:40 GMT -->
...
<input type="button" onclick="setScrollbarHighlightColor()" value="Set ScrollbarHighlightColor" />
...
<div id="result">
<h2>查看结果:</h2>
<iframe frameborder="0" name="i" src="loadtexte22d.asp?f=hdom_style_scrollbarhighlightcolor"></iframe>
</div>
