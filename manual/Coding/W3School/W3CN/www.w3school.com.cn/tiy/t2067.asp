...
<!-- Mirrored from www.w3school.com.cn/tiy/t.asp?f=xdom_httpsend_2 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:55:48 GMT -->
...
if (xmlHttp!=null)
  {
  xmlHttp.open("GET.html", "../example/xdom/note.xml", false);
  xmlHttp.send(null);
  xmlDoc=xmlHttp.responseText;

  xmlHttp.open("POST.html", "../example/xdom/demo_dom_http.html", false);
  xmlHttp.send(xmlDoc);
...
<div id="result">
<h2>查看结果:</h2>
<iframe frameborder="0" name="i" src="loadtext2067.html?f=xdom_httpsend_2"></iframe>
</div>
