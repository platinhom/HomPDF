...
document.getElementById(strId).style.borderTopRightRadius=strValue;
...
<li><input autocomplete="off" type="radio" name="rpos" onClick="test_demo(this)" id="value_7" value="50%" />50%</li>
<li><input autocomplete="off" type="radio" name="rpos" onClick="test_demo(this)" id="value_8" value="100%" />100%</li>
</ul>
</form>
...
div#DemoArea
{
border-top-right-radius:<span id="CodeValue">100px</span>;
}
</pre>
</div>
