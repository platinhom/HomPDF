...
<!-- Mirrored from www.w3school.com.cn/tiy/t.asp?f=hdom_password_maxlength by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 07:26:06 GMT -->
...
<input type="button" id="button1" onclick="alertLength()" value="Alert maxLength" />
</form>
...
<div id="result">
<h2>查看结果:</h2>
<iframe frameborder="0" name="i" src="loadtexta024.html?f=hdom_password_maxlength"></iframe>
</div>
