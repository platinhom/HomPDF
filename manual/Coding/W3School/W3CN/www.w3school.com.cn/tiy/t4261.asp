...
<!-- Mirrored from www.w3school.com.cn/tiy/t.asp?f=hdom_style_borderleftcolor by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 07:13:46 GMT -->
...
<input type="button" onclick="changeBorderColor()" value="Change left border" />
...
<div id="result">
<h2>查看结果:</h2>
<iframe frameborder="0" name="i" src="loadtext4261.html?f=hdom_style_borderleftcolor"></iframe>
</div>
