...
<!-- Mirrored from www.w3school.com.cn/tiy/t.asp?f=hdom_resetbutton by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 07:27:16 GMT -->
...
function alertId()
  {
  var txt="Id: " + document.getElementById("reset1").id
  txt=txt + ", type: " + document.getElementById("reset1").type
  txt=txt + ", value: " + document.getElementById("reset1").value
  alert(txt)
...
<form>
<input type="reset" id="reset1" value="Reset values" onclick="alertId()" />
</form>
...
<div id="result">
<h2>查看结果:</h2>
<iframe frameborder="0" name="i" src="loadtexte658.html?f=hdom_resetbutton"></iframe>
</div>
