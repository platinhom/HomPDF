...
<!-- Mirrored from www.w3school.com.cn/cssref/pr_animation-fill-mode.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 03:36:02 GMT -->
<head>
<meta charset="gbk" />
...
<h1>CSS3 animation-fill-mode 属性</h1>
...
<p>Internet Explorer 10、Firefox 以及 Opera 支持 animation-fill-mode 属性。</p>

<p>Safari 和 Chrome 支持替代的 -webkit-animation-fill-mode 属性。</p>

<p class="note"><span>注释：</span>Internet Explorer 9 以及更早的版本不支持 animation-fill-mode 属性。</p>
</div>
...
<p class="note"><span>注释：</span>其属性值是由逗号分隔的一个或多个填充模式关键词。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.animationFillMode=none</td>
  </tr>
</table>
</div>
...
<p>CSS3 教程：<a href="../css3/css3_animation.html" title="CSS3 动画">CSS3 动画</a></p>
</div>
