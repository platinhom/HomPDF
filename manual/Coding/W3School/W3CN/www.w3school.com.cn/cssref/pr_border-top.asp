...
<!-- Mirrored from www.w3school.com.cn/cssref/pr_border-top.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 06:04:36 GMT -->
<head>
<meta charset="gbk" />
...
p
  {
  border-style:solid;
  <code>border-top:thick double #ff0000;</code>
  }
</pre>

<p class="tiy"><a target="_blank" href="../tiy/t1033.html?f=csse_border-top">亲自试一试</a></p>
</div>
...
<p>border-top 简写属性把上边框的所有属性设置到一个声明中。</p>
...
<p>如果不设置其中的某个值，也不会出问题，比如 border-top:solid #ff0000; 也是允许的。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.borderTop=&quot;3px solid blue&quot;</td>
  </tr>
</table>
</div>
...
<tr>
<td><i>border-top-width</i></td>
<td>规定上边框的宽度。参阅：<a href="pr_border-top_width.html" title="CSS border-top-width 属性">border-top-width</a> 中可能的值。</td>
</tr>

<tr>
<td><i>border-top-style</i></td>
<td>规定上边框的样式。参阅：<a href="pr_border-top_style.html" title="CSS border-top-style 属性">border-top-style</a> 中可能的值。</td>
</tr>

<tr>
<td><i>border-top-color</i></td>
<td>规定上边框的颜色。参阅：<a href="pr_border-top_color.html" title="CSS border-top-color 属性">border-top-color</a> 中可能的值。</td>
</tr>

<tr>
<td>inherit</td>
<td>规定应该从父元素继承 border-top 属性的设置。</td>
</tr>
</table>
</div>
...
<dl>
<dt><a target="_blank" href="../tiy/t1033.html?f=csse_border-top">所有上边框属性在一个声明之中</a></dt>
<dd>本例演示用简写属性来将所有上边框属性设置于同一声明之中。</dd>
</dl>
</div>
...
<p>HTML DOM 参考手册：<a href="../jsref/prop_style_bordertop.html" title="HTML DOM borderTop 属性">borderTop 属性</a></p>
</div>
