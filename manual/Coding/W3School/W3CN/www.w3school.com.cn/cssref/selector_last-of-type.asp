...
<!-- Mirrored from www.w3school.com.cn/cssref/selector_last-of-type.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:31:49 GMT -->
<head>
<meta charset="gbk" />
...
<title>CSS3 :last-of-type 选择器</title>
...
<h1>CSS3 :last-of-type 选择器</h1>


<div class="backtoreference">
<p><a href="css_selectors.html" title="CSS 选择器参考手册">CSS 选择器参考手册</a></p>
</div>
...
<p>指定父元素的最后一个 p 元素的背景色：</p>

<pre>
<code>p:last-of-type</code>
{
background:#ff0000;
}
</pre>

<p class="tiy"><a target="_blank" href="../tiy/td4e6.html?f=css_sel_last-of-type">亲自试一试</a></p>
</div>
...
<p>所有主流浏览器均支持 :last-of-type 选择器，除了 IE8 及更早的版本。</p>
</div>
...
<p>:last-of-type 选择器匹配属于其父元素的特定类型的最后一个子元素的每个元素。</p>

<p class="tip"><span>提示：</span>等同于 :nth-last-of-type(1)。</p>
</div>
...
<!-- Mirrored from www.w3school.com.cn/cssref/selector_last-of-type.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:31:50 GMT -->
</html>