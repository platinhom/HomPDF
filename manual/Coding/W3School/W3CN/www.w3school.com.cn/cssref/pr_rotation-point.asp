...
<!-- Mirrored from www.w3school.com.cn/cssref/pr_rotation-point.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 03:37:49 GMT -->
<head>
<meta charset="gbk" />
...
<title>CSS3 rotation-point 属性</title>
...
<p>将 h1 元素旋转 180 度（从上向下）：</p>

<pre>
h1
{
<code>rotation-point:50% 50%;</code>
rotation:180deg;
}
</pre>

<p class="tiy"><a target="_blank" href="../tiy/t3f28.html?f=css3_rotation">亲自试一试</a></p>
</div>
...
<p>目前没有浏览器支持 rotation-point 属性。</p>
</div>
...
<p>rotation-point 属性是一对值，定义从上左边框边缘进行偏移的点。</p>

<p class="tip"><span>提示：</span>rotation-point 属性需要与 <a href="pr_rotation.html" title="CSS3 rotation 属性">rotation</a> 属性结合使用。</p>

<table class="dataintable">
  <tr>
    <th style="width:25%;">默认值：</th>
    <td style="width:75%;">50% 50%</td>
  </tr>
  <tr>
    <th>继承性：</th>
    <td>no</td>
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.rotationPoint=&quot;25% 25%&quot;</td>
  </tr>
</table>
</div>
...
<pre>rotation-point: <i>value</i>;</pre>
...
<td>如果只规定一个关键词，则第二个值将是 &quot;center&quot;。</td>
</tr>

<tr>
<td><i>x% y%</i></td>
<td>百分比值，参考边框盒宽度和高度。</td>
</tr>
