...
<!-- Mirrored from www.w3school.com.cn/cssref/pr_dim_min-width.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 03:37:52 GMT -->
<head>
<meta charset="gbk" />
...
<p class="tiy"><a target="_blank" href="../tiy/tfb58.html?f=csse_dim_min-width">亲自试一试</a></p>
</div>
...
<p>min-width 属性设置元素的最小宽度。</p>

<h3>说明</h3>

<p>该属性值会对元素的宽度设置一个最小限制。因此，元素可以比指定值宽，但不能比其窄。不允许指定负值。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.minWidth=&quot;50px&quot;</td>
  </tr>
</table>
</div>
...
<tr>
<td><i>length</i></td>
<td>定义元素的最小宽度值。默认值：取决于浏览器。</td>
</tr>

<tr>
<td><i>%</i></td>
<td>定义基于包含它的块级对象的百分比最小宽度。</td>
</tr>

<tr>
<td>inherit</td>
<td>规定应该从父元素继承 min-width 属性的值。</td>
</tr>
</table>
</div>
...
<p>CSS 参考手册：<a href="pr_dim_max-width.html" title="CSS max-width 属性">CSS max-width 属性</a></p>

<p>HTML DOM 参考手册：<a href="../jsref/prop_style_minwidth.html" title="HTML DOM minWidth 属性">minWidth 属性</a></p>
</div>
