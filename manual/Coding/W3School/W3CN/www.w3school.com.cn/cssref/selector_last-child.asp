...
<!-- Mirrored from www.w3school.com.cn/cssref/selector_last-child.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:32:58 GMT -->
<head>
<meta charset="gbk" />
...
<title>CSS3 :last-child 选择器</title>
...
<p>指定属于其父元素的最后一个子元素的 p 元素的背景色：</p>

<pre>
<code>p:last-child</code>
{ 
background:#ff0000;
}
</pre>

<p class="tiy"><a target="_blank" href="../tiy/td282.html?f=css_sel_last-child">亲自试一试</a></p>
</div>
...
<p>所有主流浏览器均支持 :last-child 选择器，除了 IE8 及更早的版本。</p>
</div>
...
<p>:last-child 选择器匹配属于其父元素的最后一个子元素的每个元素。</p>

<p class="tip"><span>提示：</span>p:last-child 等同于 p:nth-last-child(1)。</p>
</div>
...
<!-- Mirrored from www.w3school.com.cn/cssref/selector_last-child.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:32:59 GMT -->
</html>