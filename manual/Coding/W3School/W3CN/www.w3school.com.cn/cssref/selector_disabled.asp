...
<!-- Mirrored from www.w3school.com.cn/cssref/selector_disabled.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 07:09:43 GMT -->
<head>
<meta charset="gbk" />
...
<p>为所有 type=&quot;text&quot; 的被禁用的 input 元素设置背景色：</p>
...
<p class="tiy"><a target="_blank" href="../tiy/t3525.html?f=css_sel_enabled_disabled">亲自试一试</a></p>
</div>
...
<p>所有主流浏览器均支持 :disabled 选择器，除了 IE8 及更早的版本。</p>
</div>
...
<p>:disabled 选择器匹配每个被禁用的元素（大多用在表单元素上）。</p>
</div>
...
<p><a target="_blank" href="../tiy/t0737.html?f=css_sel_enabled_disabled2">亲自试一试</a></p>
</div>
