...
<!-- Mirrored from www.w3school.com.cn/cssref/pr_text_text-align.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 03:40:47 GMT -->
<head>
<meta charset="gbk" />
...
<p class="tiy"><a target="_blank" href="../tiy/t08eb.html?f=csse_text-align">亲自试一试</a></p>
</div>
...
<p>要由用户代理（而不是 CSS）来确定两端对齐文本如何拉伸，以填满父元素左右边界之间的空间。例如，有些浏览器可能只在单词之间增加额外的空间，而另外一些浏览器可能会平均分布字母间的额外空间（不过 CSS 规范特别指出，如果 <a href="pr_text_letter-spacing.html" title="CSS letter-spacing 属性">letter-spacing 属性</a>指定为一个长度值，“用户代理不能进一步增加或减少字符间的空间”）。还有一些用户代理可能会减少某些行的空间，使文本挤得更紧密。所有这些做法都会影响元素的外观，甚至改变其高度，这取决于用户代理的对齐选择影响了多少文本行。</p>
...
<h2>TIY 实例</h2>
<dl>
<dt><a target="_blank" href="../tiy/t08eb.html?f=csse_text-align">对齐文本</a></dt>
<dd>本例演示如何对齐文本。</dd>
</dl>
</div>
...
<p>CSS 教程：<a href="../css/css_text.html" title="CSS 文本">CSS 文本</a></p>
<p>HTML DOM 参考手册：<a href="../jsref/prop_style_textalign.html" title="HTML DOM textAlign 属性">textAlign 属性</a></p>
</div>
