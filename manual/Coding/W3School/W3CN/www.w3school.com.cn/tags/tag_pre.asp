...
<!-- Mirrored from www.w3school.com.cn/tags/tag_pre.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 04:13:46 GMT -->
<head>
<meta charset="gbk" />
...
<li class="currentLink"><a href="tag_pre.asp" title="HTML &lt;pre&gt; 标签">&lt;pre&gt;</a></li>
...
<p>可以导致段落断开的标签（例如标题、<a href="tag_p.html" title="HTML &lt;p&gt; 标签">&lt;p&gt;</a> 和 <a href="tag_address.html" title="HTML &lt;address&gt; 标签">&lt;address&gt; 标签</a>）<em>绝不能</em>包含在 &lt;pre&gt; 所定义的块里。尽管有些浏览器会把段落结束标签解释为简单地换行，但是这种行为在所有浏览器上并不都是一样的。</p>

<p>pre 元素中允许的文本可以包括<a href="../html/html_style.html" title="HTML 教程延伸阅读：改变文本的外观和含义">物理样式和基于内容的样式变化</a>，还有<a href="tag_a.asp" title="HTML &lt;a&gt; 标签">链接</a>、<a href="tag_img.html" title="HTML &lt;img&gt; 标签">图像</a>和<a href="tag_hr.asp" title="HTML &lt;hr&gt; 标签">水平分隔线</a>。当把其他标签（比如 &lt;a&gt; 标签）放到 &lt;pre&gt; 块中时，就像放在 HTML/XHTML 文档的其他部分中一样即可。请看下面的例子：</p>
...
<p>在上面的代码中，&lt;pre&gt; 标签中的特殊符号被转换为<a href="../html/html_entities.html" title="HTML 字符实体">符号实体</a>，比如 &quot;&amp;lt;&quot; 代表 &quot;&lt;&quot;，&quot;&amp;gt;&quot; 代表 &quot;&gt;&quot;。另外，请注意蓝色的代码，我们在 &lt;pre&gt; 标签中使用了链接，也就是 &lt;a&gt; 标签。上面这段代码的显示效果如下：</p>
...
&lt;body&gt;
  ...
  &lt;script type=&quot;text/javascript&quot;&gt;
    xmlDoc=<a href="../xmldom/dom_loadxmldoc.html">loadXMLDoc</a>(&quot;books.xml&quot;);
    document.write(&quot;xmlDoc is loaded, ready for use&quot;);
  &lt;/script&gt;
...
<p class="tip"><span>提示：</span>制表符（tab）在 &lt;pre&gt; 标签定义的块当中可以起到应有的作用，每个制表符占据 8 个字符的位置。但是我们不推荐使用它，因为在不同的浏览器中，Tab 的实现各不相同。在用 &lt;pre&gt; 标签格式化的文档段中使用空格，可以确保文本正确的水平位置。</p>

<p class="tip"><span>提示：</span>如果您希望使用 &lt;pre&gt; 标签来定义计算机源代码，比如 HTML 源代码，请使用<a href="../html/html_entities.html" title="HTML 字符实体">符号实体</a>来表示特殊字符，比如 &quot;&amp;lt;&quot; 代表 &quot;&lt;&quot;，&quot;&amp;gt;&quot; 代表 &quot;&gt;&quot;，&quot;&amp;amp;&quot; 代表 &quot;&amp;&quot;。</p>

<p class="tip"><span>提示：</span>在 W3School 中，非常多页面中的源代码实例都是通过 &lt;pre&gt; 标签定义的，您可以参考这些页面，学习如何使用该标签。我们甚至把 &lt;pre&gt; 标签与 <a href="tag_code.asp" title="HTML &lt;code&gt; 标签">&lt;code&gt; 标签</a>结合起来使用，以获得更加精确的语义。</p>
</div>
...
<p>在 HTML 4.01 中，pre 元素的 &quot;width&quot; 属性是不被赞成使用的。</p>

<p>在 XHTML 1.0 Strict DTD 中，pre 元素的 &quot;width&quot; 属性是不被支持的。</p>
</div>
...
<td>width</td>
<td>number</td>
<td>定义每行的最大字符数（通常是 40、80 或 132）。</td>
</tr>
</table>
</div>
...
<p>&lt;pre&gt; 标签支持 <a href="html_ref_standardattributes.html">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;pre&gt; 标签支持 <a href="html_ref_eventattributes.html">HTML 中的事件属性</a>。</p>
</div>
...
<dl>
<dt><a target="_blank" href="../tiy/t36cb.html?f=html_preformattedtext" title="预格式文本">预格式文本</a></dt>
<dd>此例演示如何使用pre标签对空行和空格进行控制。</dd>
</dl>
</div>
