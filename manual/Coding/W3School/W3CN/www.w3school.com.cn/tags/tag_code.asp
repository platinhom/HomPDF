...
<!-- Mirrored from www.w3school.com.cn/tags/tag_code.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 06:18:19 GMT -->
<head>
<meta charset="gbk" />
...
<p class="tip"><span>提示：</span>如果只是希望使用等宽字体的效果，请使用 <a href="tag_font_style.asp" title="HTML &lt;tt&gt; 标签">&lt;tt&gt; 标签</a>。或者，如果想要在严格限制为等宽字体格式的文本中显示编程代码，请使用 <a href="tag_pre.asp" title="HTML &lt;pre&gt; 标签">&lt;pre&gt; 标签</a>。</p>
</div>
