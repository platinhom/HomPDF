...
<!-- Mirrored from www.w3school.com.cn/tags/av_prop_buffered.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 05:25:09 GMT -->
<head>
<meta charset="gbk" />
...
<title>HTML 5 Audio/Video DOM buffered 属性</title>
...
<h1>HTML 5 Audio/Video DOM buffered 属性</h1>
...
alert(&quot;Start: &quot; + <code>myVid.buffered</code>.start(0)
+ &quot; End: &quot; + myVid.buffered.end(0));
</pre>

<p class="tiy"><a target="_blank" href="../tiy/t6603.html?f=html5_av_prop_buffered">亲自试一试</a></p>
</div>
...
<p>buffered 属性返回 TimeRanges 对象。</p>

<p>TimeRanges 对象表示用户的音视频缓冲范围。</p>

<p>缓冲范围指的是已缓冲音视频的时间范围。如果用户在音视频中跳跃播放，会得到多个缓冲范围。</p>
</div>
...
<td>
	...
	<p class="note"><span>注释：</span>首个缓冲范围的下表是 0。</p>
</td>
</tr>
</table>
</div>
