...
<!-- Mirrored from www.w3school.com.cn/tags/att_table_frame.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 06:27:18 GMT -->
<head>
<meta charset="gbk" />
...
<title>HTML &lt;table&gt; 标签的 frame 属性</title>
...
<p>下面的例子规定只有围绕表格的边框是可见的：</p>

<pre>
&lt;table <code>frame=&quot;box&quot;</code>&gt;
  &lt;tr&gt;
    &lt;th&gt;Month&lt;/th&gt;
    &lt;th&gt;Savings&lt;/th&gt;
  &lt;/tr&gt;
...
<p class="tiy"><a target="_blank" href="../tiy/tb3f2.html?f=html_table_frame">亲自试一试</a></p>
</div>


<div>
<h2>定义和用法</h2>
<p>frame 属性规定外侧边框的哪个部分是可见的。</p>
<p>从实用角度出发，最好不要规定 frame，而是使用 CSS 来添加<a href="../css/css_border.html" title="CSS 边框">边框样式</a>。</p>
</div>


<div>
<h2>浏览器支持</h2>
<p>除了 Internet Explorer，其他浏览器都支持 frame 属性。</p>
<p class="note"><span>注释：</span>Internet Explorer 以不正确的方式来显示该属性。IE 同时会显示表格内单元格的边框（而不仅仅是外侧边框）。</p>
<p class="note"><span>注释：</span>Safari 2.0 或更早的版本不支持该属性。</p>
</div>
