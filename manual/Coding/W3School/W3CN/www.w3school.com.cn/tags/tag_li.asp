...
<!-- Mirrored from www.w3school.com.cn/tags/tag_li.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 04:12:21 GMT -->
<head>
<meta charset="gbk" />
...
<li class="currentLink"><a href="tag_li.asp" title="HTML &lt;li&gt; 标签">&lt;li&gt;</a></li>
...
<p class="tiy"><a target="_blank" href="../tiy/t9c60.html?f=html_list_test">亲自试一试</a></p>
...
<p>&lt;li&gt; 标签可用在有序列表 (&lt;ol&gt;) 和无序列表 (&lt;ul&gt;) 中。</p>
</div>
...
<p>在 HTML 4.01 中，li 元素的 &quot;type&quot; 和 &quot;value&quot; 属性是不被赞成使用的。</p>

<p>在 XHTML 1.0 Strict DTD 中，li 元素的 &quot;type&quot; 和 &quot;value&quot; 属性是不被支持的。</p>
</div>
...
<p class="tip"><span>提示：</span>请使用 CSS 来定义列表和列表项目的类型。</p>
</div>
...
<tr>
<td><a href="att_li_type.html" title="HTML &lt;li&gt; 标签的 type 属性">type</a></td>
<td>
<ul>
<li>A</li>
<li>a</li>
...
<td>
	<p><span class="deprecated">不赞成使用。</span>请使用样式取代它。</p>
	<p>规定使用哪种项目符号。</p>
</td>
</tr>

<tr>
<td><a href="att_li_value.html" title="HTML &lt;li&gt; 标签的 value 属性">value</a></td>
<td><i>number</i></td>
<td>
	<p><span class="deprecated">不赞成使用。</span>请使用样式取代它。</p>
	<p>规定列表项目的数字。</p>
...
<p>&lt;li&gt; 标签支持 <a href="html_ref_standardattributes.html">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;li&gt; 标签支持 <a href="html_ref_eventattributes.html">HTML 中的事件属性</a>。</p>
</div>
...
<dl>
<dt><a target="_blank" href="../tiy/t7b16.asp?f=html_list_unordered">一个无序列表</a></dt>
<dd>本例演示一个无序列表。</dd>

<dt><a target="_blank" href="../tiy/td7be.html?f=html_lists_unordered">不同类型的无序列表</a></dt>
<dd>本例演示不同类型的无序列表。</dd>

<dt><a target="_blank" href="../tiy/t7d04.asp?f=html_list_ordered">一个有序列表</a></dt>
<dd>本例演示一个有序列表。</dd>

<dt><a target="_blank" href="../tiy/t8b2e.asp?f=html_lists_ordered">不同类型的有序列表</a></dt>
<dd>本例演示不同类型的有序列表。</dd>

<dt><a target="_blank" href="../tiy/tbd57.html?f=html_lists_nested">嵌套列表</a></dt>
<dd>本例演示如何嵌套列表。</dd>

<dt><a target="_blank" href="../tiy/t5cbd.html?f=html_lists_nested2">嵌套列表 2</a></dt>
<dd>本例演示更复杂的嵌套列表。</dd>
</dl>
</div>
...
<p>HTML DOM 参考手册：<a href="../jsref/dom_obj_li.html" title="HTML DOM Li 对象">Li 对象</a></p>
</div>
...
<!-- Mirrored from www.w3school.com.cn/tags/tag_li.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 04:12:23 GMT -->
</html>