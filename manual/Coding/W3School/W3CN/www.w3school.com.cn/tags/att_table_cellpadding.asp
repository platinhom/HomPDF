...
<!-- Mirrored from www.w3school.com.cn/tags/att_table_cellpadding.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 06:27:18 GMT -->
<head>
<meta charset="gbk" />
...
<title>HTML &lt;table&gt; 标签的 cellpadding 属性</title>
...
<h1>HTML &lt;table&gt; 标签的 cellpadding 属性</h1>
...
<p>下面的例子把表格单元边界与单元内容之间的间距设置为 10 像素：</p>

<pre>
&lt;table border=&quot;8&quot; <code>cellpadding=&quot;10&quot;</code>&gt;
  &lt;tr&gt;
    &lt;th&gt;Month&lt;/th&gt;
    &lt;th&gt;Savings&lt;/th&gt;
  &lt;/tr&gt;
...
<p class="tiy"><a target="_blank" href="../tiy/taac4.html?f=html_table_cellpadding">亲自试一试</a></p>
</div>


<div>
<h2>定义和用法</h2>
<p>cellpadding 属性规定单元边沿与其内容之间的空白。</p>
<p class="note"><span>注释：</span>请勿将该属性与 <a href="att_table_cellspacing.html" title="HTML &lt;table&gt; 标签的 cellspacing 属性">cellspacing 属性</a>相混淆，cellspacing 属性规定的是单元之间的空间。</p>
<p>从实用角度出发，最好不要规定 cellpadding，而是使用 CSS 来添加<a href="../css/css_padding.html" title="CSS 内边距">内边距</a>。</p>
</div>
...
<pre>&lt;body cellpadding=&quot;<i>value</i>&quot;&gt;</pre>
