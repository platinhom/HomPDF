...
<!-- Mirrored from www.w3school.com.cn/tags/tag_acronym.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 04:01:19 GMT -->
<head>
<meta charset="gbk" />
...
<li class="currentLink"><a href="tag_acronym.asp" title="HTML &lt;acronym&gt; 标签">&lt;acronym&gt;</a></li>
...
<p class="tiy"><a target="_blank" href="../tiy/tb1c0.html?f=html_acronym">亲自试一试</a></p>
</div>
...
<p>所有主流的浏览器均支持 &lt;acronym&gt; 标签。</p>

<p class="note"><span>注释：</span>IE 5.5 或更早版本的 IE 浏览器不支持 &lt;acronym&gt; 标签。</p>
</div>
...
<p><span class="marked">HTML5 中不支持 &lt;acronym&gt; 标签。请使用 <a href="tag_abbr.html" title="HTML &lt;abbr&gt; 标签">&lt;abbr&gt;</a> 标签代替。</span></p>

<p>&lt;acronym&gt; 标签定义首字母缩写。</p>

<p>缩写能够作为单词来朗读，例如 NATO, NASA, ASAP, GUI。</p>

<p>通过对缩写进行标记，您能够为浏览器、拼写检查和搜索引擎提供有用的信息。</p>
</div>
...
<p>提示：title 属性可用于在鼠标指针移动到元素上时显示出缩写的完整版本。</p>
</div>
...
<p>HTML5 中不支持 &lt;acronym&gt; 标签，但是在 HTML 4.01 中支持。</p>
</div>
...
<pre>id, class, title, style, dir, lang, xml:lang</pre>
...
<pre>onclick, ondblclick, onmousedown, onmouseup, onmouseover, 
onmousemove, onmouseout, onkeypress, onkeydown, onkeyup 
</pre>

<p>如需完整的描述，请访问<a href="html_ref_eventattributes.html">事件属性</a>。</p>
</div>
...
<dl>
<dt><a target="_blank" href="../tiy/te0c5.html?f=html_abbracronym" title="缩写和首字母缩写">缩写和首字母缩写</a></dt>
...
<!-- Mirrored from www.w3school.com.cn/tags/tag_acronym.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 04:01:20 GMT -->
</html>