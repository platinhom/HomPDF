...
<!-- Mirrored from www.w3school.com.cn/tags/att_thead_charoff.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 06:30:55 GMT -->
<head>
<meta charset="gbk" />
...
<title>HTML &lt;thead&gt; 标签的 charoff 属性</title>
...
<h1>HTML &lt;thead&gt; 标签的 charoff 属性</h1>


<div class="backtoreference">
<p><a href="tag_thead.html">HTML &lt;thead&gt; 标签</a></p>
</div>
...
<p>下面的 HTML 表格把 thead 元素中的内容与字符 &quot;M&quot; 向右两个字符的位置对齐：</p>

<pre>
&lt;table border=&quot;1&quot; width=&quot;100%&quot;&gt;
  &lt;thead align=&quot;char&quot; char=&quot;M&quot; <code>charoff="2"</code>&gt;
    &lt;tr&gt;
      &lt;th&gt;Month&lt;/th&gt;
      &lt;th&gt;Savings&lt;/th&gt;
    &lt;/tr&gt;
...
<p class="tiy"><a target="_blank" href="../tiy/t7f6a.html?f=html_thead_charoff">亲自试一试</a></p>
</div>


<div>
<h2>定义和用法</h2>
<p>charoff 属性规定 thead 元素中的内容相对于由 char 属性规定的字符的对齐偏移量。</p>
<p>仅当 align 属性设置为 &quot;char&quot; 且已设置 char 属性时，才能使用 charoff 属性。</p>
</div>


<div>
<h2>浏览器支持</h2>
<p>几乎没有浏览器支持 charoff 属性。</p>
</div>
...
<pre>&lt;thead charoff=&quot;<i>value</i>&quot;&gt;</pre>
...
<div>
<h2>延伸阅读：char 和 charoff 属性</h2>
<p>即使是最简单的文字处理器也允许在表格中排列十进制数字中的点。直到 HTML 4.0 标准的出现，网页设计语言一直不能充分满足这方面的要求。</p>
<p>现在，可以使用 char 属性，来指定表格行内单元格中的一个字母，这个字母就是对齐的中心线。不需要为 char 指定值。如果你没有指定的话，默认的字符是基于语言：例如，在英语中是一个句点，而在法语中是一个逗号。如果把一个单字符指定为 char 属性的值，则可以指定不同的对齐字符。</p>
<p>使用 charoff 属性和一个整数值可指定每行对齐字符第一次出现的偏移量。如果一行中不包括对齐字符，应该水平平移到对齐位置的最后。</p>
<p>char 和 charoff 属性在 HTML 4 和 XHTML 中是新出现的属性，还没有得到任何一个流行浏览器的支持。</p>
</div>
...
<!-- Mirrored from www.w3school.com.cn/tags/att_thead_charoff.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 06:30:57 GMT -->
</html>