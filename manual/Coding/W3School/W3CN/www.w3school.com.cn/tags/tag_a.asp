...
<!-- Mirrored from www.w3school.com.cn/tags/tag_a.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 04:01:12 GMT -->
<head>
<meta charset="gbk" />
...
<li class="currentLink"><a href="tag_a.asp" title="HTML &lt;a&gt; 标签">&lt;a&gt;</a></li>
...
<p class="tiy"><a target="_blank" href="../tiy/t8e17.html?f=html_a">亲自试一试</a></p>
</div>
...
<p class="tip"><span>提示：</span>您可能已经注意到了，W3School 站点内的链接外观与默认的链接外观非常不同。您可以使用 <a href="../css/css_pseudo_classes.html" title="CSS 伪类 (Pseudo-classes)">CSS 伪类</a> 向文本超链接添加复杂而多样的样式。</p>
</div>
...
<p><a href="tag_term_hypertext.html">什么是超文本？</a></p>
</div>
...
<div>
<h2>HTML 4.01 与 HTML5 之间的差异</h2>

<p>在 HTML 4.01 中，&lt;a&gt; 标签可以是超链接或锚。在 HTML5 中，&lt;a&gt; 标签始终是超链接，但是如果未设置 href 属性，则只是超链接的占位符。</p>

<p>HTML5 提供了一些新属性，同时不再支持一些 HTML 4.01 属性。</p>
</div>
...
<tr>
<td><a href="att_a_charset.html" title="HTML &lt;a&gt; 标签的 charset 属性">charset</a></td>
<td><i>char_encoding</i></td>
<td><span class="marked">HTML5 中不支持。</span>规定被链接文档的字符集。</td>
</tr>

<tr>
<td><a href="att_a_coords.html" title="HTML &lt;a&gt; 标签的 coords 属性">coords</a></td>
<td><i>coordinates</i></td>
<td><span class="marked">HTML5 中不支持。</span>规定链接的坐标。</td>
</tr>

<tr>
<td class="html5_new"><a href="att_a_download.html" title="HTML5 &lt;a&gt; download 属性">download</a></td>
<td><i>filename</i></td>
<td>规定被下载的超链接目标。</td>
</tr>

<tr>
<td><a href="att_a_href.html" title="HTML &lt;a&gt; 标签的 href 属性">href</a></td>
<td><i>URL</i></td>
<td>规定链接指向的页面的 URL。</td>
</tr>

<tr>
<td><a href="att_a_hreflang.html" title="HTML &lt;a&gt; 标签的 hreflang 属性">hreflang</a></td>
<td><i>language_code</i></td>
<td>规定被链接文档的语言。</td>
</tr>

<tr>
<td class="html5_new"><a href="att_a_media.html" title="HTML5 &lt;a&gt; media 属性">media</a></td>
<td><i>media_query</i></td>
<td>规定被链接文档是为何种媒介/设备优化的。</td>
</tr>

<tr>
<td><a href="att_a_name.html" title="HTML &lt;a&gt; 标签的 name 属性">name</a></td>
<td><i>section_name</i></td>
<td><span class="marked">HTML5 中不支持。</span>规定锚的名称。</td>
</tr>

<tr>
<td><a href="att_a_rel.html" title="HTML &lt;a&gt; 标签的 rel 属性">rel</a></td>
<td><i>text</i></td>
<td>规定当前文档与被链接文档之间的关系。</td>
</tr>

<tr>
<td><a href="att_a_rev.html" title="HTML &lt;a&gt; 标签的 rev 属性">rev</a></td>
<td><i>text</i></td>
<td><span class="marked">HTML5 中不支持。</span>规定被链接文档与当前文档之间的关系。</td>
</tr>

<tr>
<td><a href="att_a_shape.html" title="HTML &lt;a&gt; 标签的 shape 属性">shape</a></td>
<td>
	<ul>
	<li>default</li>
	<li>rect</li>
...
<tr>
<td><a href="att_a_target.html" title="HTML &lt;a&gt; 标签的 target 属性">target</a></td>
<td>
	<ul>
	<li>_blank</li>
	<li>_parent</li>
...
<tr>
<td class="html5_new"><a href="att_a_type.html" title="HTML5 &lt;a&gt; type 属性">type</a></td>
<td><i>MIME type</i></td>
...
<p>&lt;a&gt; 标签支持 <a href="html_ref_standardattributes.html">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;a&gt; 标签支持 <a href="html_ref_eventattributes.html">HTML 中的事件属性</a>。</p>
</div>
...
<dl>
<dt><a target="_blank" href="../tiy/t6030.html?f=html_links">创建超级链接</a></dt>
<dd>本例演示如何在 HTML 文档中创建链接。</dd>
<dt><a target="_blank" href="../tiy/t69bb.html?f=html_imglink">将图像作为链接</a></dt>
<dd>本例演示如何使用图像作为链接。</dd>
<dt><a target="_blank" href="../tiy/tfb8d.html?f=html_link_locations">链接到同一个页面的不同位置</a></dt>
<dd>本例演示如何使用链接跳转至文档的另一个部分</dd>
<dt><a target="_blank" href="../tiy/t10bb.html?f=html_link_target">在新的浏览器窗口打开链接</a></dt>
<dd>本例演示如何在新窗口打开一个页面，这样的话访问者就无需离开你的站点了。</dd>
<dt><a target="_blank" href="../tiy/t310a.asp?f=html_frame_getfree">跳出框架</a></dt>
<dd>本例演示如何跳出框架，假如你的页面被固定在框架之内。</dd>
<dt><a target="_blank" href="../tiy/t1c22.html?f=html_mailto">创建电子邮件链接</a></dt>
<dd>本例演示如何如何链接到一个邮件。（本例在安装邮件客户端程序后才能工作。）</dd>
<dt><a target="_blank" href="../tiy/t5991.html?f=html_mailto2">创建电子邮件链接 2</a></dt>
<dd>本例演示更加复杂的邮件链接。</dd>
</dl>
</div>
...
<p>HTML 教程：<a href="../html/html_links.html" title="HTML 链接">HTML 链接</a></p>

<p>HTML DOM 参考手册：<a href="../jsref/dom_obj_anchor.html" title="HTML DOM Anchor 对象">Anchor 对象</a></p>
</div>
...
<!-- Mirrored from www.w3school.com.cn/tags/tag_a.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 04:01:19 GMT -->
</html>