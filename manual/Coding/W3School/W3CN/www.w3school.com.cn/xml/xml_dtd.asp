...
<!-- Mirrored from www.w3school.com.cn/xml/xml_dtd.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 03:19:12 GMT -->
<head>
...
<li class="currentLink"><a href="xml_dtd.asp" title="XML 验证">XML 验证</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="xml_attributes.html" title="XML 属性">XML 属性</a></li>
<li class="next"><a href="xml_validator.html" title="XML 验证器">XML 验证器</a></li>
</ul>
</div>

<div id="intro">
<p><strong>拥有正确语法的 XML 被称为“形式良好”的 XML。</strong></p>
<p><strong>通过 DTD 验证的 XML 是“合法”的 XML。</strong></p>
</div>
...
<p><strong>“形式良好”或“结构良好”的 XML 文档拥有正确的语法。</strong></p>
...
<code>&lt;!DOCTYPE note SYSTEM &quot;Note.dtd&quot;&gt;</code>
&lt;note&gt;
&lt;to&gt;George&lt;/to&gt;
&lt;from&gt;John&lt;/from&gt;
&lt;heading&gt;Reminder&lt;/heading&gt;
...
<p>在上例中，DOCTYPE 声明是对外部 DTD 文件的引用。下面的段落展示了这个文件的内容。</p>
</div>
...
<p>如果您希望学习 DTD，请访问我们的 <a href="../dtd/index.html">DTD 教程</a>。</p>
</div>
...
<p>如果您需要学习 XML Schema，请访问我们的 <a href="../schema/index.html">XML Schema 教程</a>。</p>
</div>

<div>
<h2>一个通用的验证器</h2>

<p>为了帮助您检查 XML 文件的语法，我们创建了这个工具，以便您对任何 XML 文件进行语法检查。</p>
