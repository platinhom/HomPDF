...
<!-- Mirrored from www.w3school.com.cn/xml/xml_usedfor.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 03:19:12 GMT -->
<head>
...
<li class="currentLink"><a href="xml_usedfor.asp" title="XML 的用途">XML 用途</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="xml_intro.html" title="XML 简介">XML 简介</a></li>
<li class="next"><a href="xml_tree.html" title="XML 树结构">XML 树结构</a></li>
</ul>
</div>


<div id="intro">
<p><strong>XML 应用于 web 开发的许多方面，常用于简化数据的存储和共享。</strong></p>
</div>


<div>
<h2>XML 把数据从 HTML 分离</h2>
...
<p class="tip"><span>提示：</span>您将在稍后的章节学习更多这方面的内容。</p>
</div>
...
<p>由于 XML 独立于硬件、软件以及应用程序，XML 使您的数据更可用，也更有用。</p>

<p>不同的应用程序都能够访问您的数据，不仅仅在 HTML 页中，也可以从 XML 数据源中进行访问。</p>

<p>通过 XML，您的数据可供各种阅读设备使用（手持的计算机、语音设备、新闻阅读器等），还可以供盲人或其他残障人士使用。</p>
</div>


<div>
<h2>XML 用于创建新的 Internet 语言</h2>
...
<p><strong>假如他们都是理性的，就让未来的应用程序使用 XML 来交换数据吧。</strong></p>

<p>未来也许会出现某种字处理软件、电子表格程序以及数据库，它们可以使用纯文本格式读取彼此的数据，而不需要使用任何的转换程序。</p>

<p>我们现在能做的只有祈祷微软公司和所有其他的软件开发商在这一方面取得一致了。</p>
</div>
