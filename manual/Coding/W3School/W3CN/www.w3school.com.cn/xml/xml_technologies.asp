...
<!-- Mirrored from www.w3school.com.cn/xml/xml_technologies.asp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2015 03:19:36 GMT -->
<head>
...
<li><a href="xml_savedata.asp" title="把数据存储到 XML 文件">XML 数据存储</a></li>
<li class="currentLink"><a href="xml_technologies.asp" title="XML 的相关技术">XML 技术</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="xml_savedata.asp" title="把数据存储到 XML 文件">XML 数据存储</a></li>
<li class="next"><a href="xml_real_life.html" title="现实生活中的 XML">XML 现实案例</a></li>
</ul>
</div>

<div id="intro">
<p><strong>下面是一个与 XML 相关的技术的列表。</strong></p>
</div>

<div>
<dl class="define">
<dt><a href="../xhtml/index.html" title="XHTML 教程">XHTML</a></dt>
<dd>更严格更纯净的基于 XML 的 HTML 版本。</dd>

<dt><a href="../xmldom/index.html" title="XML DOM 教程">XML DOM</a></dt>
<dd>访问和操作 XML 的标准文档模型。</dd>

<dt><a href="../xsl/xsl_languages.html" title="XSLT 教程">XSLT</a></dt>
<dd>
<p>XSL 包含三个部分：</p>
<ul>
<li><a href="../xsl/index.html" title="XSLT 教程">XSLT</a> - 把 XML 转换为其他格式，比如 HTML</li>
<li><a href="../xslfo/index.asp" title="XSL-FO 教程">XSL-FO</a> - 用于格式化 XML 文档的语言</li>
<li><a href="../xpath/index.html" title="XPath 教程">XPath</a> - 用于在 XML 文档中导航的语言</li>
</ul>
</dd>

<dt><a href="../xquery/index.html" title="XQuery 教程">XQuery</a></dt>
<dd>基于 XML 的用于查询 XML 数据的语言。</dd>

<dt><a href="../dtd/index.html" title="DTD 教程">DTD</a></dt>
<dd>用于定义 XML 文档中的合法元素的标准。</dd>

<dt><a href="../schema/index.html" title="Schema 教程">XSD</a></dt>
<dd>XML Schema。基于 XML 的 DTD 替代物。</dd>

<dt><a href="../xlink/index.html" title="XLink 教程">XLink</a></dt>
<dd>在 XML 文档中创建超级链接的语言。</dd>

<dt><a href="../xlink/index.html" title="XPointer 教程">XPointer</a></dt>
<dd>允许 XLink 超级链接指向 XML 文档中更多具体的部分。</dd>

<dt><a href="../xforms/index.html" title="XForms 教程">XForms</a></dt>
<dd>使用 XML 定义表单数据。</dd>

<dt><a href="../soap/index.html" title="SOAP 教程">SOAP</a></dt>
<dd>允许应用程序在 HTTP 之上交换信息的基于 XML 的协议。</dd>

<dt><a href="../wsdl/index.html" title="WSDL 教程">WSDL</a></dt>
<dd>用于描述网络服务的基于 XML 的语言。</dd>

<dt><a href="../rdf/index.html" title="RDF 教程">RDF</a></dt>
<dd>用于描述网络资源的基于 XML 的语言。</dd>

<dt><a href="../rss/index.html" title="RSS 教程">RSS</a></dt>
<dd>聚合新闻以及类新闻站点内容的格式。</dd>

<dt><a href="../wap/index.html" title="WAP 教程">WAP</a></dt>
<dd>用于在无线设备上（比如移动电话）显示内容的一种基于 XML 的语言。</dd>

<dt><a href="../smil/index.html" title="SMIL 教程">SMIL</a></dt>
<dd>描述视听呈现的语言。</dd>

<dt><a href="../svg/index.html" title="SVG 教程">SVG</a></dt>
<dd>使用 XML 格式定义图形。</dd>
</dl>
</div>
