...
<ul>
<li><a href="index.html" title="WAP 教程">WAP 教程</a></li>
<li><a href="wap_intro.html" title="WAP 简介">WAP 简介</a></li>
<li><a href="wap_basic.html" title="WAP 基础">WAP 基础</a></li>
<li><a href="wml_format.html" title="WML 格式化">WML 格式化</a></li>
<li><a href="wml_links.html" title="WML 链接和图像">WML 连接</a></li>
<li><a href="wml_input.html" title="WML 输入">WML 输入</a></li>
<li><a href="wml_tasks.html" title="WML 任务">WML 任务</a></li>
<li><a href="wml_timer.html" title="WML 计时器">WML 计时器</a></li>
<li><a href="wml_variables.html" title="WML 变量">WML 变量</a></li>
<li><a href="wml_examples.html" title="WML 实例">WML 实例</a></li>
<li><a href="wap_demo.html" title="WAP 演示">WAP 演示</a></li>
<li><a href="wap_pages.html" title="从您的移动电话访问 W3School.com.cn">WAP W3School</a></li>
</ul>
<h2>参考手册</h2>
<ul>
<li><a href="wml_reference.html" title="WML 参考手册">WML 参考手册</a></li>
<li><a href="wml_entities.asp" title="WML 实体">WML 实体</a></li>
<li><a href="wml_dtd.html" title="WML DTD">WML DTD</a></li>
</ul>
<h2>参考手册</h2>
<ul>
<li><a href="wap_forum.html" title="WAP 论坛 / 开放移动联盟">WAP 论坛/OMA</a></li>
<li class="currentLink"><a href="wap_software.asp" title="WAP 软件">WAP 软件</a></li>
</ul>
</div><div id="selected">
<h2>建站手册</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="wap_forum.html" title="WAP 论坛 / 开放移动联盟">WAP 论坛/OMA</a></li>
<li class="next"><a href="index.html" title="WAP 教程">WAP 教程</a></li>
</ul>
</div>
...
<p>Symbian 于 1998 年 6 月作为一家私有的独立公司成立，并被下列公司共同拥有：爱立信、诺基亚、松下、摩托罗拉、Psion、西门子以及索尼爱立信。</p>

<p>Symbian 提供先进的开放标准操作系统 - Symbian OS - 针对允许数据传送 (data-enabled) 的移动电话。</p>
</div>

<div>
<h2>MobileDev - 无线应用开发 (Wireless Application Development)</h2>
...
<p>MobileDev comes complete with its own powerful integrated runtime engine, MobileDev Server Script. Server Script can quickly create prototypes or build full-blown business WAP applications that can be natively connected to an RDBMS. MobileDev WDE is also designed to support development in ASP, JSP, Perl or other template-based server technologies.</p>
</div>
...
<div id="tools">
<h5 id="tools_reference"><a href="wml_reference.html">WML 参考手册</a></h5>
<h5 id="tools_example"><a href="wap_demo.html">WAP 演示</a></h5>
</div>
